...
---
# <a name="connect-windows-virtual-machines-created-with-hello-classic-deployment-model-with-a-virtual-network-or-cloud-service"></a>Połączenie maszyn wirtualnych systemu Windows utworzonych za pomocą hello klasycznego modelu wdrażania z wirtualnych sieci lub usługę w chmurze
> [!IMPORTANT]
...
Utworzone za pomocą hello klasycznego modelu wdrażania maszyn wirtualnych systemu Windows są zawsze umieszczane w usłudze w chmurze. Usługa w chmurze Hello działa jako kontener i udostępnia unikatowy publicznej nazwy DNS, publiczny adres IP i zestaw maszyny wirtualnej hello tooaccess punktów końcowych w porównaniu z hello Internet. usługi w chmurze Hello może znajdować się w sieci wirtualnej, ale nie jest wymagane. Możesz również [połączenie maszyn wirtualnych systemu Linux za pomocą wirtualnej sieci lub w chmurze usługi](../../linux/classic/connect-vms.md).
