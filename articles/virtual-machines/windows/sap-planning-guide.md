...
* [SAP NetWeaver na maszynach wirtualnych Azure (maszyny wirtualne) — przewodnik wdrażania DBMS][dbms-guide]
...
Istnieją również wersje professional eksploratory usługi Storage platformy Azure, której można znaleźć tutaj:
...
zgodnie z opisem w: <https://help.sap.com/saphelp_nwpi71/helpdata/en/47/c56a6938fb2d65e10000000a42189c/content.htm>
...
Inny element ważne infrastruktury wysokiej dostępności jest magazynu. Na przykład Umowy dotyczącej poziomu usług magazynu Azure jest 99,9% dostępności. Jeśli jeden wdraża wszystkich maszyn wirtualnych z jego dysków do jednego konta magazynu Azure, potencjalne magazynu Azure niedostępności spowoduje niedostępność wszystkich maszyn wirtualnych, które są umieszczone na tym koncie magazynu Azure, a także wszystkie SAP składniki działają w ramach tych maszyn wirtualnych.  
