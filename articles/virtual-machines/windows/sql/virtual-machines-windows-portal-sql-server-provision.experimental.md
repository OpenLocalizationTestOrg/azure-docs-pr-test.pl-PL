...
> [!NOTE]
> Można dodać więcej ograniczeń komunikacji sieciowej z maszyną wirtualną programu SQL Server. Możesz dodać więcej ograniczeń, edytując sieciową grupę zabezpieczeń po utworzeniu maszyny wirtualnej. Aby uzyskać więcej informacji, zobacz [What is a Network Security Group (NSG)?](../../../virtual-network/virtual-networks-nsg.md) (Co to jest sieciowa grupa zabezpieczeń?).
> 
> 
...
> [!NOTE]
> Jeśli planujesz dostęp do programu SQL Server za pośrednictwem Internetu (tzn. opcji łączności publicznej), musisz w tym miejscu włączyć uwierzytelnianie SQL. Publiczny dostęp do programu SQL Server wymaga użycia uwierzytelniania SQL.
> 
> 
...
Można włączyć [usługi języka R programu SQL Server](https://msdn.microsoft.com/library/mt604845.aspx). Usługi języka R programu SQL Server umożliwiają korzystanie z zaawansowanych funkcji analizy za pomocą programu SQL Server 2016. Kliknij pozycję **Włącz** w bloku **Ustawienia programu SQL Server**.
