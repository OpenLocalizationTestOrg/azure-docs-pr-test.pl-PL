# Omówienie
## [Co to jest program SQL Server na maszynach wirtualnych platformy Azure?](virtual-machines-windows-sql-server-iaas-overview.md) 
...
# Wprowadzenie
## [Zapewnij maszyny Wirtualnej w ramach hello portalu Azure](virtual-machines-windows-portal-sql-server-provision.md)
## [Aprowizowanie maszyny wirtualnej przy użyciu programu Azure PowerShell](virtual-machines-windows-ps-sql-create.md)
## [Połącz tooa maszyny Wirtualnej](virtual-machines-windows-sql-connect.md)
...
## Zarządzanie
### [Użyj hello rozszerzenia agenta programu SQL Server IaaS](virtual-machines-windows-sql-server-agent-extension.md)
