...
Ten skrypt tworzy maszynę wirtualną platformy Azure z systemem Windows Server 2016, a następnie używa hello Azure maszyny wirtualnej niestandardowe rozszerzenie skryptu tooinstall usług IIS. Po uruchomieniu skryptu hello, można uzyskać dostępu do hello domyślna witryna sieci Web IIS na publiczny adres IP hello hello maszyny wirtualnej.
...
| [Zestaw AzureRmVMExtension](/powershell/module/azurerm.compute/set-azurermvmextension) | Dodaj maszynę wirtualną toohello rozszerzenia maszyny Wirtualnej. W tym przykładzie hello niestandardowe rozszerzenie skryptu jest używany tooinstall usług IIS. |
