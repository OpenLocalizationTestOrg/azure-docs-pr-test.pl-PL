...
Ten skrypt tworzy maszynę wirtualną platformy Azure z systemem Windows Server 2016. Po uruchomieniu skryptu hello, można uzyskać dostępu do maszyny wirtualnej hello za pośrednictwem protokołu RDP.
