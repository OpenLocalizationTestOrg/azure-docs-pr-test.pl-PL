...
---
# <a name="create-a-wordpress-vm-with-powershell"></a>Tworzenie maszyny Wirtualnej WordPress przy użyciu programu PowerShell

Ten skrypt tworzy maszynę wirtualną i używa hello maszyny wirtualnej Azure skryptu niestandardowego rozszerzenia tooinstall WordPress. Po uruchamianie skryptu hello, można uzyskać dostępu do hello WordPress konfiguracji witryny na `http://<public IP of VM>/wordpress`. 
...
| [Zestaw AzureRmVMExtension](/powershell/module/azurerm.compute/set-azurermvmextension) | Dodaj maszynę wirtualną toohello niestandardowe rozszerzenie skryptu hello, która wywołuje skrypt tooinstall WordPress. |
