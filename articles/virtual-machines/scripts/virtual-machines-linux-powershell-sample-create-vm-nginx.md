...
Ten skrypt tworzy maszynę wirtualną platformy Azure, a następnie używa hello Azure maszyny wirtualnej niestandardowe rozszerzenie skryptu tooinstall NGINX. Po uruchomieniu skryptu hello, można uzyskać dostępu do pokaz witryny sieci Web na publiczny adres IP hello hello maszyny wirtualnej.
...
| [Zestaw AzureRmVMExtension](/powershell/module/azurerm.compute/set-azurermvmextension) | Dodaj maszynę wirtualną toohello rozszerzenia maszyny Wirtualnej. W tym przykładzie hello niestandardowe rozszerzenie skryptu jest używany tooinstall NGINX. |
