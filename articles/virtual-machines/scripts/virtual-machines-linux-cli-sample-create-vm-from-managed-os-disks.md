...
[!code-azurecli-interactive[główne](../../../cli_scripts/virtual-machine/create-vm-attach-existing-managed-os-disk/create-vm-attach-existing-managed-os-disk.sh "Utwórz maszynę Wirtualną z dyskiem zarządzanym")]
...
| Polecenie | Uwagi |
|---|---|
| [Pokaż dysku az](https://docs.microsoft.com/cli/azure/disk#show) | Pobiera właściwości dysków zarządzanych przy użyciu nazwy dysku i nazwę grupy zasobów. Identyfikator jest używana do podłączenia dysków zarządzanych do nowej maszyny Wirtualnej |
