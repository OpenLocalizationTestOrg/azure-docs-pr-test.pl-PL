...
Ten skrypt tworzy maszynę wirtualną platformy Azure, instaluje hello agenta Operations Management Suite (OMS) i rejestruje hello system z obszarem roboczym pakietu OMS. Po uruchomieniu skryptu hello hello maszyny wirtualnej będzie widoczny w konsoli OMS hello. Ponadto należy tooupdate hello OMS klucz obszaru roboczego identyfikator i obszaru roboczego.
