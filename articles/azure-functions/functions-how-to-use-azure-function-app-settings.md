...
Aby uzyskać więcej informacji na temat pracy z ustawieniami usługi aplikacji, zobacz [Konfigurowanie ustawień usługi aplikacji Azure](../app-service-web/web-sites-configure.md).
