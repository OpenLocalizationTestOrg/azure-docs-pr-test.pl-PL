...
Ten przykładowy skrypt tworzy aplikację funkcji Azure to kontener dla funkcji. Funkcja aplikacji Hello jest tworzony przy użyciu dedykowanych planu usługi aplikacji, co oznacza, że zasoby serwera są zawsze włączone.
...
| [Tworzenie konta magazynu az](https://docs.microsoft.com/cli/azure/storage/account#create) | Tworzy konto magazynu Azure. |
| [Tworzenie planu usług aplikacji az](https://docs.microsoft.com/cli/azure/appserviceplan#create) | Tworzy plan usługi App Service. |
| [Utwórz az functionapp](https://docs.microsoft.com/cli/azure/functionapp#delete) | Tworzy aplikację funkcji platformy Azure. |
