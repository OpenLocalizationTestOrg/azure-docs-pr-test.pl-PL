...
> [!IMPORTANT]
> $newapp. SiteConfig.NumberOfWorkers jest inny formularz $newapp. MaxNumberOfWorkers. Każdej aplikacji odbierającej używa $newapp. SiteConfig.NumberOfWorkers, aby określić właściwości skalowania aplikacji.
