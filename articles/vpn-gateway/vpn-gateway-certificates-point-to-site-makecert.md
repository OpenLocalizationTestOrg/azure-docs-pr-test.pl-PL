...
* Dla **Resource Manager** kroków modelu wdrażania, zobacz [skonfigurowano połączenia punkt-lokacja z sieci wirtualnej](vpn-gateway-howto-point-to-site-resource-manager-portal.md).
