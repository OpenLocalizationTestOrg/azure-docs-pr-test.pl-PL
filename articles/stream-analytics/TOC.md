...
### [Funkcje tooAzure danych wyjściowych](stream-analytics-functions-redis.md)
### [Dane wyjściowe tooData Lake — Magazyn](stream-analytics-data-lake-output.md)
### [TooDocumentDB danych wyjściowych](stream-analytics-documentdb-output.md)

## Monitorowanie i optymalizowanie
### [Dodawanie alertów](stream-analytics-set-up-alerts.md)
...
### [Optymalizacja jednostek przesyłania strumieniowego](stream-analytics-streaming-unit-consumption.md)
### [Przepływność tooincrease skali](stream-analytics-scale-jobs.md)
...
### [Użyj hello Management .NET SDK](stream-analytics-dotnet-management-sdk.md)
