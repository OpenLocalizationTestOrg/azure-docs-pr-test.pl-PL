...
Każdy punkt końcowy ma interfejsów API dla wykonywania wsadowego i wykonywania synchronicznego. Analiza strumienia używa synchronicznej. Nosi nazwę określonej usługi [żądania/odpowiedzi usługi](../machine-learning/machine-learning-consume-web-services.md) w studio uczenie maszynowe Azure.
