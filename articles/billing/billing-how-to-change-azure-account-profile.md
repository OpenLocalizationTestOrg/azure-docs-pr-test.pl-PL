...
1. Zaloguj się do [Centrum konta platformy Azure](https://account.windowsazure.com/) jako konto administratora, a następnie kliknij przycisk **profilu**. 
2. Wybierz **Edytuj szczegóły** przycisk, a następnie zaktualizuj **profilu** informacji.

   ![Profil](./media/billing-how-to-change-azure-account-profile/profile.png)

## <a name="frequently-asked-questions"></a>Często zadawane pytania
### <a name="can-notifications-be-sent-to-a-different-email-address-other-than-the-account-owner-email-address-associated-with-my-account"></a>Czy powiadomienia mogą być wysyłane na adres e-mail inny niż adres właściciela konta skojarzony z moim kontem?
...
Dowiedz się, jak zaktualizować informacji rozliczeniowych sprawdzając [zmienić karty kredytowej do realizacji płatności subskrypcji platformy Azure](billing-how-to-change-credit-card.md).
