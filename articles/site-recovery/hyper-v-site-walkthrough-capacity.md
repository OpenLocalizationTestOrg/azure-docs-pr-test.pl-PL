...
---
# <a name="step-3-plan-capacity-and-scaling-for-hyper-v-tooazure-replication"></a>Krok 3: Planowanie wydajności i skalowania dla funkcji Hyper-V tooAzure replikacji

Użyj tego artykułu toofigure Planowanie pojemności i skalowanie podczas replikowania lokalnych maszyn wirtualnych funkcji Hyper-V (bez programu System Center VMM) tooAzure z [usługi Azure Site Recovery](site-recovery-overview.md).
...
Przejdź za[krok 4: Planowanie sieci](hyper-v-site-walkthrough-network.md).
