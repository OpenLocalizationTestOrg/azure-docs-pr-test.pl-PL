...
3. **Źródło i cel**:
    ...
    ![Replikacja VMM/funkcji Hyper-V w systemie Azure](./media/site-recovery-components/arch-onprem-onprem-azure-vmm.png) ![replikacji lokacji funkcji Hyper-V do platformy Azure](./media/site-recovery-components/arch-onprem-azure-hypervsite.png)
