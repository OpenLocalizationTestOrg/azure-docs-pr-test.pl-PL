...
* [Automatyzacja interfejsu API REST](http://msdn.microsoft.com/library/mt662285.aspx)
* [Elementy runbook społeczności](https://gallery.technet.microsoft.com/scriptcenter/site/search?f%5B0%5D.Type=RootCategory&f%5B0%5D.Value=WindowsAzure&f%5B0%5D.Text=Windows%20Azure)
...
* [Interfejs API REST analizy dzienników](/rest/api/loganalytics)
* [Moduł zbierający dane HTTP analizy dziennika interfejsu API](../log-analytics/log-analytics-data-collector-api.md)
* [Dziennik wyszukiwania interfejsu API REST](../log-analytics/log-analytics-log-search-api.md)
* [Interfejs API REST alertu](../log-analytics/log-analytics-api-alerts.md)
* [Polecenia cmdlet programu PowerShell analizy dzienników](https://msdn.microsoft.com/library/mt188224.aspx)
* [Biblioteki .NET analizy dzienników](https://www.nuget.org/packages/Microsoft.Azure.Management.OperationalInsights/0.16.0-preview)

## <a name="service-map"></a>Mapa usługi
* [Dokumentacja mapy usług](operations-management-suite-service-map.md)
* [Mapa usług interfejsu API REST](https://docs.microsoft.com/rest/api/servicemap/)
