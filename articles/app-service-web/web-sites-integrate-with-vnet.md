...
Ten dokument koncentruje się przede wszystkim na potrzeby integracji sieci wirtualnej przy użyciu portalu Azure. Aby włączyć integrację sieci wirtualnej z aplikacji przy użyciu programu PowerShell, postępuj zgodnie z instrukcjami w tym miejscu: [łączenie aplikacji z sieci wirtualnej przy użyciu programu PowerShell][IntPowershell].
