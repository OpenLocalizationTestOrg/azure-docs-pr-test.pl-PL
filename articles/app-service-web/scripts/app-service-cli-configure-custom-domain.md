...
---
# <a name="map-a-custom-domain-to-a-web-app"></a>Zamapować niestandardową domenę do aplikacji sieci web
...
[!code-azurecli-interactive[główne](../../../cli_scripts/app-service/configure-custom-domain/configure-custom-domain.sh?highlight=3 "zamapować niestandardową domenę do aplikacji sieci web")]
