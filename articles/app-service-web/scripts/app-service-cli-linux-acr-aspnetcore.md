...
W tym scenariuszu dowiesz się, jak toocreate grupę zasobów aplikacji w systemie Linux usługi planowania i aplikacji sieci web i wdrażanie aplikacji platformy ASP.NET Core za pomocą kontenera Docker z hello rejestru kontenera platformy Azure.
...
Ten skrypt używa hello następujące polecenia toocreate grupę zasobów, aplikacji sieci web i wszystkie powiązane zasoby. Każde polecenie w tabeli hello łączy toocommand szczegółowej dokumentacji.
...
| [zestaw kontenera konfiguracji aplikacji sieci Web az](https://docs.microsoft.com/cli/azure/webapp/config/container#set) | Ustawia kontener Docker hello hello aplikacji sieci web platformy Azure. |
