...
[!code-azurecli-interactive[główne](../../../cli_scripts/app-service/monitor-with-logs/monitor-with-logs.sh "dzienników monitorowania")]
...
| [Pobieranie dziennika az aplikacji sieci Web](https://docs.microsoft.com/cli/azure/webapp/log#download) | Pobieranie dzienników z aplikacji sieci web platformy Azure na komputerze lokalnym. |
