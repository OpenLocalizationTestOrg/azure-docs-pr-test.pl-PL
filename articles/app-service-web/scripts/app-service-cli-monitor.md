...
| [AZ aplikacji sieci Web dziennika konfiguracji](https://docs.microsoft.com/cli/azure/webapp/log#config) | Określa, które dzienników aplikacji sieci web platformy Azure zostanie utrzymana. |
| [Pobieranie dziennika az aplikacji sieci Web](https://docs.microsoft.com/cli/azure/webapp/log#download) | Pliki do pobrania hello rejestruje hello tooyour aplikacji sieci web platformy Azure dla komputera lokalnego. |
