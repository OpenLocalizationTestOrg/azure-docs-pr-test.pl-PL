...
---
# <a name="create-an-aspnet-core-web-app-in-a-docker-container"></a>Tworzenie aplikacji sieci web platformy ASP.NET Core w kontenerze Docker

W tym scenariuszu dowiesz się, jak utworzyć grupę zasobów, planu usług aplikacji dla systemu Linux i aplikacji sieci web i wdrażanie aplikacji platformy ASP.NET Core za pomocą kontenera Docker.
...
[!code-azurecli-interactive[główne](../../../cli_scripts/app-service/deploy-linux-docker/deploy-linux-docker.sh?highlight=6 "Docker systemu Linux")]
