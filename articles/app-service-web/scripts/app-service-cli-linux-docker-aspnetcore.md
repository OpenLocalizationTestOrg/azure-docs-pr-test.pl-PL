...
W tym scenariuszu dowiesz się, jak toocreate grupę zasobów aplikacji w systemie Linux usługi planowania i aplikacji sieci web i wdrażanie aplikacji platformy ASP.NET Core za pomocą kontenera Docker.
