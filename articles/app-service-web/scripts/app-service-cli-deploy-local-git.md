...
[!code-azurecli-interactive[główne](../../../cli_scripts/app-service/deploy-local-git/deploy-local-git.sh?highlight=3-5 "tworzenie aplikacji sieci web i wdrażanie kodu z lokalnego repozytorium Git")]
