...
Ten skrypt używa hello następujące polecenia toocreate grupę zasobów, aplikacji sieci web, konto magazynu oraz wszystkie powiązane zasoby. Każde polecenie w tabeli hello łączy toocommand szczegółowej dokumentacji.
...
| [Tworzenie konta magazynu az](https://docs.microsoft.com/cli/azure/storage/account#create) | Tworzy konto magazynu. Jest to przechowywania hello zasoby statyczne. |
