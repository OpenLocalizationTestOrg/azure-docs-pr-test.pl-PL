...
[!code-azurecli-interactive[główne](../../../cli_scripts/app-service/scale-manual/scale-manual.sh "Manual Scale")]
...
| [Aktualizacja planu usługi aplikacji az](https://docs.microsoft.com/cli/azure/appservice/plan#update) | Aktualizuje właściwości planu usługi aplikacji. |
