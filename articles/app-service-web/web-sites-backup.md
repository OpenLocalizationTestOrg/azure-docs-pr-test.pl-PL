...
Przekaż `_backup.filter` pliku `D:\home\site\wwwroot\` katalog swoją witrynę przy użyciu [ftp](web-sites-deploy.md#ftp) lub innej metody. Jeśli chcesz, można utworzyć pliku bezpośrednio za pomocą Kudu `DebugConsole` i Wstaw zawartość istnieje.
