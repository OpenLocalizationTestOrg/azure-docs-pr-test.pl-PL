...
Aby uzyskać więcej informacji, zobacz [wdrażanie aplikacji w usłudze App Service](web-sites-deploy.md).
...
Samouczek [tworzenie pierwszej aplikacji sieci web platformy ASP.NET na platformie Azure w ciągu pięciu minut](https://docs.microsoft.com/azure/app-service-web/web-sites-dotnet-get-started/) pokazuje, jak wdrożyć aplikację sieci web platformy ASP.NET w aplikacji sieci web w usłudze App Service przy użyciu programu Visual Studio 2015.
