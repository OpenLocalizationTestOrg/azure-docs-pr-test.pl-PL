...
Środowiska usługi aplikacji mogą być tworzone w **albo** sieci wirtualnej platformy Azure Resource Manager **lub** sieci wirtualnej wdrożenia klasycznego modelu.  Z ostatnie zmiany wprowadzone w czerwca 2016 ASEs można teraz również wdrożyć do sieci wirtualnych korzystających z zakresów adresów publicznych lub przestrzenie adresowe RFC1918 (tj.) adresy prywatne). 
