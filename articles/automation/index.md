            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p><a href="/powershell/servicemanagement/azure.automation/v3.1.0/azure.automation">Klasyczny program PowerShell</a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>REST</h3>
                        <p><a href="/rest/api/automation/">Interfejs API REST</a></p>
                        <p><a href="https://msdn.microsoft.com/library/azure/mt163781">Klasyczny interfejs API REST</a></p>
                    </div>
                </div>
            </div>
        </div>
