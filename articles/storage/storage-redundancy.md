...
> [!NOTE]
> Magazyn plików Azure obsługuje magazyn tylko lokalnie nadmiarowy (LRS) i magazynu georedundant (GRS). Informacje o magazyn plików Azure znajdują się w temacie [omówienie magazyn plików Azure](storage-files-introduction.md).
>
