...
* Są to samouczków dotyczących za pomocą biblioteki klienta .NET można utworzyć sygnatury dostępu współdzielonego i przechowywane zasad dostępu.
  ...
  * [Udostępnione sygnatur dostępu, część 2: Tworzenie i sygnatury dostępu Współdzielonego za pomocą usługi Blob](storage-dotnet-shared-access-signature-part-2.md)
