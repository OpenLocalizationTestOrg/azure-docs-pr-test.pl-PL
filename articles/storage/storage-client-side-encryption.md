...
[Przykłady szyfrowania](https://github.com/Azure/azure-storage-net/tree/master/Samples/GettingStarted/EncryptionSamples) pokazują scenariusza bardziej szczegółowe end-to-end dla obiektów blob, kolejek i tabel, wraz z Integracja magazynu kluczy.
...
* [Samouczek: Szyfrowanie i odszyfrowywanie obiektów blob w magazynie platformy Microsoft Azure przy użyciu usługi Azure Key Vault](storage-encrypt-decrypt-blobs-key-vault.md)
