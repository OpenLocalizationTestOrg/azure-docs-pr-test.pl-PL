...
### [Tworzenie udziału plików](storage-file-how-to-create-file-share.md)
...
### [Dołącz tooa dysków zarządzanych w maszyny Wirtualnej systemu Windows przy użyciu programu PowerShell](../virtual-machines/windows/attach-disk-ps.md)
...
### [Przeszukiwanie magazynu obiektów blob za pomocą usługi Azure Search](../search/search-blob-storage-integration.md)
...
### [Tooblobs dostęp anonimowy](storage-manage-access-to-resources.md)
...
### [Przykłady](https://azure.microsoft.com/documentation/samples/?service=storage&term=queue)
## Korzystanie z tabel
...
### [Migrację dysków zarządzanych tooAzure maszynach wirtualnych platformy Azure](../virtual-machines/windows/migrate-to-managed-disks.md)
### [Migrowanie z usług AWS i innych platform tooManaged dysków](../virtual-machines/windows/on-prem-to-azure.md)
...
#### [Migrowanie tooPremium magazynu przy użyciu usługi Azure Site Recovery](storage-migrate-to-premium-storage-using-azure-site-recovery.md)
...
#### [Migrowanie tooPremium magazynu](storage-migration-to-premium-storage.md)
...
### [Replikacja](storage-redundancy.md)
...
### [Użyj hello emulatora magazynu](storage-use-emulator.md)
...
## Transfer danych
### [Przenieś tooand danych z magazynu](storage-moving-data.md)
### [Narzędzie AzCopy w systemie Windows](storage-use-azcopy.md)
### [Narzędzie AzCopy w systemie Linux](storage-use-azcopy-linux.md)
### [Za pomocą usługi Import/Eksport hello](storage-import-export-service.md)
### [Za pomocą narzędzia importu/eksportu hello](storage-import-export-tool-how-to.md)
#### [Konfigurowanie hello narzędzie importu/eksportu](storage-import-export-tool-setup.md)
...
#### [Rozwiązywanie problemów z hello narzędzie importu/eksportu](storage-import-export-tool-troubleshooting-v1.md)
...
### [Przy użyciu hello narzędzie importu/eksportu (wersja 1)](storage-import-export-tool-how-to-v1.md)
#### [Konfigurowanie hello narzędzie importu/eksportu](storage-import-export-tool-setup-v1.md)
...
#### [Format pliku właściwości i metadanych usługi Import/Export](storage-import-export-file-format-metadata-and-properties.md)
#### [Format pliku dziennika usługi Import/Export](storage-import-export-file-format-log.md)
### [Przy użyciu interfejsu API REST usługi Import/Eksport Azure hello](storage-import-export-using-the-rest-api.md)
...
## REST
### [Obiekty blob, kolejki, tabele i pliki](/rest/api/storageservices)
