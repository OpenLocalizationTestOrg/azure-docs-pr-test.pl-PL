...
Utwórz [przyrostowe migawki](storage-incremental-snapshots.md) dla dysków premium niezarządzane hello sam sposobu korzystania z magazynu w warstwie standardowa migawki. Magazyn w warstwie Premium obsługuje tylko lokalnie nadmiarowego magazynu jako hello opcji replikacji. Zaleca się, że tworzenie migawki, a następnie skopiuj hello migawki tooa standardowy magazyn geograficznie nadmiarowy konta. Aby uzyskać więcej informacji, zobacz [opcje nadmiarowość magazynu Azure](storage-redundancy.md).
...
* [Migrowanie tooAzure magazyn w warstwie Premium](storage-migration-to-premium-storage.md)
