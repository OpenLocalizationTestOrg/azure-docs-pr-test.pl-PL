...
toocreate udziału plików platformy Azure, korzystając z konta magazynu, który już istnieje, lub [Utwórz nowe konto magazynu Azure](storage-create-storage-account.md). toocreate udziału plików platformy Azure przy użyciu programu PowerShell, konieczne będzie hello klucz konta i nazwę konta magazynu. Jeśli planujesz toouse programu Powershell lub interfejsu wiersza polecenia, należy klucz konta magazynu.
...
1. **Blok konta tooStorage Przejdź w portalu Azure**:    
    ![Blok Konto magazynu](media/storage-file-how-to-create-file-share/create-file-share-portal1.png)

2. **Kliknij przycisk Dodaj udział pliku**:    
    ![Kliknij przycisk hello Dodawanie przycisku udziału plików](media/storage-file-how-to-create-file-share/create-file-share-portal2.png)

3. **Podaj nazwę i limit przydziału. Obecnie maksymalna wartość przydziału wynosi 5 TB**:    
    ![Podaj nazwę i żądany przydział hello nowego udziału plików](media/storage-file-how-to-create-file-share/create-file-share-portal3.png)

4. **Wyświetl nowy udział plików**: ![Wyświetl swój nowy udział plików](media/storage-file-how-to-create-file-share/create-file-share-portal4.png)

5. **Przekaż plik**: ![Przekaż plik](media/storage-file-how-to-create-file-share/create-file-share-portal5.png)

6. **Przejdź do udziału plików i zarządzaj swoimi plikami i katalogami**: ![Przeglądaj udział plików](media/storage-file-how-to-create-file-share/create-file-share-portal6.png)
...
* [Łączenie i instalowanie udziału plików — system Windows](storage-file-how-to-use-files-windows.md)
* [Łączenie i instalowanie udziału plików — system Linux](storage-how-to-use-files-linux.md)
* [Łączenie i instalowanie udziału plików — system macOS](storage-file-how-to-use-files-mac.md)
