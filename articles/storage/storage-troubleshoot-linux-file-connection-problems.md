...
Ograniczenia hello liczby równoczesnych otwartych dojść zamykając niektóre dojść, a następnie ponów operację hello. Aby uzyskać więcej informacji, zobacz [Lista kontrolna wydajności i skalowalności magazynu Microsoft Azure](storage-performance-checklist.md).
