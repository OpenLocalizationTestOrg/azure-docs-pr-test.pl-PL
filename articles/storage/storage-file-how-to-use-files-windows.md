...
3. **Ścieżka UNC hello kopiowania z okienka "Połącz" hello w portalu Azure hello**: szczegółowy opis sposobu toofind te informacje można znaleźć [tutaj](storage-file-how-to-use-files-portal.md#connect-to-file-share).
