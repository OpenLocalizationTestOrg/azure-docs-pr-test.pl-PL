...
Możesz przypinać diagramu lub tabeli do jednego z Twojej [udostępnionych pulpitów nawigacyjnych](app-insights-dashboards.md) — wystarczy kliknąć numer pin. (Może być konieczne [uaktualniania aplikacji przez cennik pakietu](app-insights-pricing.md) Aby włączyć tę funkcję.) 
