...
W tym temacie porównuje możliwości kodowania hello **Media Encoder Standard** i **Media Encoder Premium w przepływie pracy**.

## <a name="video-and-audio-processing-capabilities"></a>Możliwości przetwarzania audio i wideo

Hello w poniższej tabeli porównano funkcje hello między Media Encoder Standard (rynkowej) a Media Encoder Premium przepływu pracy (MEPW). 

|Możliwości|Usługa Media Encoder Standard|Przepływ pracy usługi Media Encoder w warstwie Premium|
|---|---|---|
|Zastosuj logikę warunkową podczas kodowania<br/>(na przykład, jeśli dane wejściowe hello jest HD, następnie zakodować 5.1 audio)|Nie|Tak|
...
| --- | --- | --- |
| **Usługa Media Encoder Standard** |KODER |Kodowanie zadania zostanie naliczona opłata oparte na hello całkowity czas trwania (w minutach) wszystkie pliki multimedialne hello tworzone jako dane wyjściowe szybkością hello określony [tutaj][1], w kolumnie KODERA hello. |
| **Przepływ pracy usługi Media Encoder w warstwie Premium** |KODER PREMIUM |Kodowanie zadania zostanie naliczona opłata oparte na hello całkowity czas trwania (w minutach) wszystkie pliki multimedialne hello tworzone jako dane wyjściowe szybkością hello określony [tutaj][1], w kolumnie KODER PREMIUM hello. |
...
| --- | --- | --- |
| AVC 8-bitowych/10-bitowy, się too4:2:2, w tym AVCIntra |8 bitów 4:2:0 a 4:2:2 |Tak |
| Avid DNxHD (w MXF) |Tak |Tak |
| DVCPro/DVCProHD (w MXF) |Tak |Tak |
| JPEG2000 |Tak |Tak |
| MPEG-2 (too422 profilu i wysoki poziom; tym wariantów, takich jak XDCAM, XDCAM HD, XDCAM IMX, CableLabs® i D10) |Too422 profilu |Tak |
| MPEG-1 |Tak |Tak |
...
| AAC (AAC-LC, AAC HE i AAC-HEv2; zapasowej too5.1) |Tak |Tak |
...
| --- | --- | --- |
| AVC (H.264; 8-bitową w górę tooHigh profilu, poziom 5.2; HD bardzo 4K; Wewnątrz AVC) |Tylko 8 bitów 4:2:0 |Tak |
| Avid DNxHD (w MXF) |Nie |Tak |
| MPEG-2 (too422 profilu i wysoki poziom; tym wariantów, takich jak XDCAM, XDCAM HD, XDCAM IMX, CableLabs® i D10) |Nie |Tak |
| MPEG-1 |Nie |Tak |
...
| AES (SMPTE 331 M i 302 M, AES3 2003) |Nie |Tak |
| Dolby® cyfrowy (AC3) |Nie |Tak |
| Dolby® Digital Plus (E-AC3) się too7.1 |Nie |Tak |
| AAC (AAC-LC, AAC HE i AAC-HEv2; zapasowej too5.1) |Tak |Tak |
