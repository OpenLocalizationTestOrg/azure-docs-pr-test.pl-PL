...
Ten samouczek przedstawia kroki wdrażania podstawowej usługi dostarczania zawartości wideo na żądanie (VoD) z aplikacją Azure Media Services (AMS) przy użyciu języka Java hello.
...
* Witaj biblioteki Azure dla języka Java, które można zainstalować z hello [Azure Java Developer Center][Azure Java Developer Center].
...
Witaj poniższy kod przedstawia sposób toocreate zasób, Przekaż zasób toohello pliku nośnika, uruchom zadanie z zadań tootransform hello zawartości i tworzenia toostream lokalizatora wideo.

Należy tooset konto usługi Media Services przed rozpoczęciem korzystania z tego kodu. Informacje na temat ustawienia konta, zobacz [jak tooCreate konta usługi Media Services](media-services-portal-create-account.md).

Podstaw wartości zmiennych hello "clientId" i "clientSecret". Witaj kod korzysta również lokalnie przechowywanych plików. Będziesz potrzebować tooprovide toouse własny plik.
