...
---
# <a name="drivers-for-azure-sql-data-warehouse"></a>Sterowniki dla magazynu danych Azure SQL
Możesz połączyć tooSQL hurtowni danych takich jak z kilku różnych aplikacji protokołów [ADO.NET][ADO.NET], [ODBC][ODBC], [PHP] [ PHP] i [JDBC][JDBC]. Poniżej przedstawiono kilka przykładów ciągi połączenia dla każdego protokołu.  Umożliwia także hello toobuild portalu Azure w ciągu połączenia.  toobuild ciągu połączenia za pomocą hello portalu Azure Przejdź tooyour bloku bazy danych, w obszarze *Essentials* kliknij *Pokaż parametry połączenia bazy danych*.
...
> [!NOTE]
> Rozważ ustawienie hello połączenia too300 liczba sekund limitu czasu w kolejności tooallow hello połączenia toosurvive krótkich okresach niedostępności.
> 
> 
