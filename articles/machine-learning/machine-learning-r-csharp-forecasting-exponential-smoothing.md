...
---
# <a name="deprecated-forecasting---exponential-smoothing"></a>(przestarzałe) Funkcja prognozowania - Wygładzanie wykładnicze
...
Ta usługa akceptuje 4 argumenty i oblicza hello ETS prognozy.
...
Istnieje wiele sposobów używania usługi hello w zautomatyzowany sposób (przykładową aplikację jest [tutaj](http://microsoftazuremachinelearning.azurewebsites.net/etsForecasting.aspx)).
...
Za pomocą w usłudze Azure Machine Learning nowy pusty eksperyment została utworzona. Przekazany ze schematem wstępnie zdefiniowanych danych przykładowych danych wejściowych. Schemat danych połączonych toohello jest [wykonanie skryptu języka R] [ execute-r-script] moduł, który generuje hello ETS prognozowania modelu przy użyciu funkcji "ets" i "prognozy" z R. 
...
Jest bardzo prosty przykład ETS prognozowania. Jak wynika z powyższych hello przykładowy kod, nie błąd Przechwytywanie jest zaimplementowana, a usługa hello przyjęto założenie, że wszystkie zmienne hello są ciągłe/dodatnie wartości i częstotliwość hello musi być liczbą całkowitą większą niż 1. Długość Hello wektorów hello wartość daty i powinien hello w tej samej. Zmienna daty Hello przestrzegać toohello format "mm/dd/rrrr'.
