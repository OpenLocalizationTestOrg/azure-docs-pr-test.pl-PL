...
Teraz możesz pracować z Pandas DataFrame, jak to opisano w temacie [danych obiektów Blob platformy Azure procesu w danym środowisku nauki danych](machine-learning-data-science-process-data-blob.md).

## <a name="cortana-analytics-process-in-action-example"></a>Proces Cortana analityka w przykładzie akcji
Aby proces Analytics Cortana, przy użyciu publicznego zestawu danych, na przykład na trasie wskazówki, zobacz [zespołu danych nauki procesu w działaniu: przy użyciu programu SQL Server](machine-learning-data-science-process-sql-walkthrough.md).
