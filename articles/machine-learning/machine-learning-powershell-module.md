...
Aby uzyskać więcej informacji na temat przypadek użycia, zobacz w tym artykule przy użyciu modułu programu PowerShell, aby zautomatyzować zadanie najczęściej wymagane: [utworzyć wiele modeli uczenia maszynowego i sieci web punktów końcowych usługi z doświadczenia przy użyciu programu PowerShell](machine-learning-create-models-and-endpoints-with-powershell.md).
...
Rozszerzone przykład sposobu użycia modułu w rzeczywistych scenariuszy, zapoznaj się z przypadek użycia szczegółowych, [utworzyć wiele modeli uczenia maszynowego i sieci web punktów końcowych usługi z doświadczenia przy użyciu programu PowerShell](machine-learning-create-models-and-endpoints-with-powershell.md).
