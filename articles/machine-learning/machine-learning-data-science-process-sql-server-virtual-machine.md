...
Teraz możesz pracować z Pandas ramki danych, co opisano w artykule [danych obiektów Blob platformy Azure procesu w danym środowisku nauki danych](machine-learning-data-science-process-data-blob.md).

## <a name="azure-data-science-in-action-example"></a>Nauki danych Azure w przykładzie akcji
Na przykład wskazówki end-to-end procesu nauki danych Azure przy użyciu publicznego zestawu danych, zobacz [proces nauki danych Azure, w akcji](machine-learning-data-science-process-sql-walkthrough.md).
