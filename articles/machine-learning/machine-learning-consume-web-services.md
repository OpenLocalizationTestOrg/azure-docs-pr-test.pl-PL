...
---
# <a name="how-tooconsume-an-azure-machine-learning-web-service"></a>Jak tooconsume usługi sieci Web Azure Machine Learning

Gdy wdrażanie usługi Azure Machine Learning model predykcyjny jako usługę sieci Web, możesz użyć toosend interfejsu API REST go prognoz danych i get. Możesz wysłać hello danych w czasie rzeczywistym lub w trybie wsadowym.

Można znaleźć więcej informacji na temat toocreate i wdrażanie usługi Machine Learning w sieci Web przy użyciu usługi Machine Learning Studio, w tym miejscu:
