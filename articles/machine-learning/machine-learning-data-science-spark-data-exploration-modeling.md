...
Do wykorzystania i wynik niezależne zestawu danych opisanego w [wynik i ocena modeli uczenia maszynowego wbudowane Spark](machine-learning-data-science-spark-model-consumption.md) tematu, należy skopiować i wkleić te nazwy pliku zawierającego zapisany modeli utworzonych w tym miejscu do notesu Jupyter zużycia. Oto kod, aby wydrukować ścieżki do plików modelu, który należy.
