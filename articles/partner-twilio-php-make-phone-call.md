...
3. Zainstaluj zestaw Azure SDK for PHP. Omówienie zestawu SDK i instrukcje dotyczące instalacji, zobacz [skonfigurować zestaw Azure SDK dla języka PHP](app-service-web/web-sites-php-mysql-deploy-use-git.md)
...
Następnym krokiem jest wdrażanie aplikacji w usłudze Azure Websites. Poniższe artykuły zawierają informacje dotyczące tworzenia witryny sieci Web i wdrażanie kodu za pomocą narzędzia Git, FTP lub WebMatrix (choć nie wszystkie informacje w każdym artykule są odpowiednie):
