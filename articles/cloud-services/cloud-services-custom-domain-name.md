...
> [!NOTE]
> Procedury w tym zadaniu mają zastosowanie do usługi w chmurze Azure. Dla usług aplikacji, zobacz [to](../app-service-web/web-sites-custom-domain-name.md). W przypadku kont magazynu, zobacz [to](../storage/blobs/storage-custom-domain-name.md).
> 
> 
