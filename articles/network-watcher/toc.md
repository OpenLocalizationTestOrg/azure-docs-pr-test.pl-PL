...
## Sprawdź tooand przepływów IP z maszyny Wirtualnej
...
## [Analizowanie anomalii toofind przechwytywania pakietów](network-watcher-deep-packet-inspection.md)
## [Użyj pakietów przechwytywania toodo aktywnego monitorowania sieci w środowisku Azure Functions](network-watcher-alert-triggered-packet-capture.md)
