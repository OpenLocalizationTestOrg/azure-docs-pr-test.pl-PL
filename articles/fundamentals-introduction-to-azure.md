...
Strona [porównania Azure Web Apps, usługi w chmurze i maszyn wirtualnych](app-service-web/choose-web-site-cloud-service-vm.md) zawiera bardziej szczegółowe informacje na temat wybierania modelu obliczeń.
