...
---
# <a name="use-powershell-toosync-between-multiple-azure-sql-databases"></a>Użyj programu PowerShell toosync między wiele baz danych Azure SQL
 
W tym przykładzie programu PowerShell konfiguruje toosync synchronizacji danych między wiele baz danych Azure SQL.
