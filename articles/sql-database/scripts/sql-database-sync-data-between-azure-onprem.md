...
---
# <a name="use-powershell-toosync-between-an-azure-sql-database-and-a-sql-server-on-premises-database"></a>Użyj programu PowerShell toosync między bazą danych SQL Azure i lokalnej bazy danych programu SQL Server

W tym przykładzie programu PowerShell konfiguruje toosync synchronizacji danych między bazą danych SQL Azure i lokalnej bazy danych programu SQL Server. 

W tym przykładzie wymaga hello Azure PowerShell modułu w wersji 4.2 lub nowszej. Uruchom `Get-Module -ListAvailable AzureRM` toofind hello zainstalowanych wersji. Jeśli potrzebujesz tooinstall lub uaktualniania, zobacz [modułu instalacji programu Azure PowerShell](https://docs.microsoft.com/en-us/powershell/azure/install-azurerm-ps).
...
Po uruchomieniu hello przykładowy skrypt można uruchomić następujące grupy zasobów hello tooremove polecenia hello i wszystkie zasoby skojarzone z nim.
...
| Polecenie | Uwagi |
|---|---|
| [Nowe AzureRmSqlSyncAgent](/powershell/module/azurerm.sql/New-AzureRmSqlSyncAgent) |  Tworzy nowy Agent synchronizacji |
| [Nowe AzureRmSqlSyncAgentKey](/powershell/module/azurerm.sql/New-AzureRmSqlSyncAgentKey) |  Generuje klucz agenta hello skojarzony z hello synchronizacji agenta |
| [Get-AzureRmSqlSyncAgentLinkedDatabase](/powershell/module/azurerm.sql/Get-AzureRmSqlSyncAgentLinkedDatabase) |  Pobierz wszystkie informacje hello hello Agent synchronizacji |
| [Nowe AzureRmSqlSyncMember](/powershell/module/azurerm.sql/New-AzureRmSqlSyncMember) |  Dodaj nowy toohello członek grupy synchronizacji |
| [AzureRmSqlSyncSchema aktualizacji](/powershell/module/azurerm.sql/Update-AzureRmSqlSyncSchema) |  Odświeża hello informacji o schemacie bazy danych |
| [Get-AzureRmSqlSyncSchema](/powershell/module/azurerm.sql/Get-AzureRmSqlSyncSchem) |  Uzyskanie informacji o schemacie bazy danych hello |
| [AzureRmSqlSyncGroup aktualizacji](/powershell/module/azurerm.sql/Update-AzureRmSqlSyncGroup) |  Aktualizacje hello grupy synchronizacji |
| [Start AzureRmSqlSyncGroupSync](/powershell/module/azurerm.sql/Start-AzureRmSqlSyncGroupSync) | Wyzwalacze synchronizacji |
| [Get-AzureRmSqlSyncGroupLog](/powershell/module/azurerm.sql/Get-AzureRmSqlSyncGroupLog) |  Sprawdza hello dziennika synchronizacji |
|||
