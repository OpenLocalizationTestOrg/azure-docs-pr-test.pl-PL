...
Platforma Azure udostępnia kilka ofert umożliwia obsługę aplikacji programu .NET. Porównanie różnych ofert jest dostępna w [porównanie usługi Azure App Service, usługi w chmurze i maszyn wirtualnych](../app-service-web/choose-web-site-cloud-service-vm.md). Jeśli system operacyjny gościa oferty jest mniejsza niż .NET 4.6.1 wymagane dla transakcji elastycznej, należy uaktualnić system operacyjny gościa do wersji 4.6.1. 
