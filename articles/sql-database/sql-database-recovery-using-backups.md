...
Można również użyć [automatyczne kopie zapasowe bazy danych](sql-database-automated-backups.md) utworzyć [kopiowanie bazy danych](sql-database-copy.md) na dowolnym serwerze logicznym w dowolnym regionie. 
