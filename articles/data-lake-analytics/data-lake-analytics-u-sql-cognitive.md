...
### <a name="extract-emotions-from-human-faces"></a>Wyodrębnij emocji z powierzchni człowieka 
...
### <a name="estimate-age-and-gender-for-human-faces"></a>Szacowanie wieku i płci dla człowieka powierzchni
...
### <a name="detect-text-in-images-ocr"></a>Wykryj tekst obrazów (Rozpoznawania)
...
## <a name="text-scenarios"></a>Scenariusze tekstu

### <a name="input-data"></a>Dane wejściowe

Załóżmy, będziemy mieć składający się z "War i pokoju" dane wejściowe przez Leo Tolstoy.
...
### <a name="extract-key-phrases-for-each-paragraph"></a>Wyodrębnij klucza wyrażenia dla każdego akapitu
...
### <a name="perform-sentiment-analysis-on-each-paragraph"></a>Przeprowadzania analizy wskaźniki nastrojów klientów dla każdego akapitu
