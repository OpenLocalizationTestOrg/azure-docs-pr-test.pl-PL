...
* **Przekaż przykładowe dane do konta usługi Data Lake Analytics.** Zobacz [można skopiować pliki danych przykładowych](data-lake-analytics-get-started-portal.md).

    Do uruchomienia zadania w usłudze Data Lake Analytics potrzebne są określone dane. Chociaż narzędzia Data Lake Tools obsługują przekazywanie danych, przekaż przykładowe dane za pośrednictwem portalu, aby łatwiej wykonać instrukcje przedstawione w tym samouczku.
