...
Rozwiązanie Analytics aplikacji sieci Web platformy Azure (wersja zapoznawcza) zapewnia wgląd w Twoje [Azure Web Apps](../app-service-web/app-service-web-overview.md) przez zbieranie metryk różnych różnych zasobów aplikacji sieci Web platformy Azure. Dzięki rozwiązaniu można było analizować i wyszukiwać dane metryki zasobów aplikacji sieci web.
