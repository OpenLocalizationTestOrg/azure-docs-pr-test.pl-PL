...
> [!NOTE]
> Łącznik usługi Analiza dzienników Azure dla programu Microsoft Flow wymaga obszaru roboczego zostaną uaktualnione do nowego języka zapytań usługi Analiza dzienników. Możesz dowiedzieć się więcej o nowy język i uzyskać Procedura uaktualniania obszaru roboczego na [uaktualnienia obszaru roboczego analizy dzienników Azure do nowego wyszukiwania dziennika](log-analytics-log-search-upgrade.md).  
