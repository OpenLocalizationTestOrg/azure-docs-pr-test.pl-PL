# Omówienie
## [Wprowadzenie tooAzure fabryki danych](data-factory-introduction.md)
## Pojęcia
...
# Wprowadzenie
## [Samouczek: Tworzenie danych toocopy potoku](data-factory-copy-data-from-azure-blob-storage-to-sql-database.md)
...
## [Samouczek: Tworzenie danych tootransform potoku](data-factory-build-your-first-pipeline.md)
...
#### [Omówienie](data-factory-data-management-gateway.md)
#### [High availability and scalability (Preview) (Wysoka dostępność i skalowalność [wersja zapoznawcza])](data-factory-data-management-gateway-high-availability-scalability.md)
#### [Wskazówki: Przenoszenia danych z lokalnego programu SQL Server tooAzure magazynu obiektów Blob](data-factory-move-data-between-onprem-and-cloud.md)
