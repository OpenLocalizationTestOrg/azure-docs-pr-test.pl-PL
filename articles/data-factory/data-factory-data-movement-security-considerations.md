...
W ramach rozwiązania fabryki danych jest tworzony co najmniej jeden [potok](data-factory-create-pipelines.md) danych. Potok to logiczne grupowanie działań wykonujących zadania. Potoki te znajdują się w regionie, w której został utworzony z fabryką danych. 
