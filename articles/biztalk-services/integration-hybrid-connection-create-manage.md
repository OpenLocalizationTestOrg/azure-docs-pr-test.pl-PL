...
**Aby utworzyć połączeń hybrydowych było możliwe za pomocą aplikacji sieci Web**, zobacz [połączenia aplikacji sieci Web platformy Azure do zasobu lokalnego](../app-service-web/web-sites-hybrid-connection-get-started.md). Menedżer połączeń hybrydowych (HCM) można także zainstalować z aplikacji sieci web, która jest to preferowana metoda. 
...
Aby połączyć aplikację sieci Web lub aplikacji mobilnej w usłudze Azure App Service istniejące połączenie hybrydowe, wybierz **Użyj istniejącego połączenia hybrydowego** w bloku połączeń hybrydowych było możliwe. Zobacz [dostępu do zasobów lokalnych za pomocą połączeń hybrydowych w usłudze Azure App Service](../app-service-web/web-sites-hybrid-connection-get-started.md).
...
[Łączenie aplikacji sieci Web platformy Azure z zasobami lokalnymi](../app-service-web/web-sites-hybrid-connection-get-started.md)  
[Połączenie z lokalnym programem SQL Server z aplikacji sieci Web platformy Azure](../app-service-web/web-sites-hybrid-connection-connect-on-premises-sql-server.md)   
