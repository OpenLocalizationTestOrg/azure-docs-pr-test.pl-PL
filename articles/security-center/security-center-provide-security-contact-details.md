...
1. W **zalecenia** bloku, wybierz opcję **podać szczegóły dotyczące kontaktu zabezpieczeń**.
   ![Podaj kontaktu zabezpieczeń][1]
2. Spowoduje to otwarcie bloku **podać szczegóły dotyczące kontaktu zabezpieczeń**. Wybierz subskrypcję platformy Azure, aby udostępnić informacje kontaktowe na.
...
3. Drugi **podać szczegóły dotyczące kontaktu zabezpieczeń** zostanie otwarty blok.
   ...
   * Wybierz **OK** do zastosowania zabezpieczeń informacji kontaktowych do subskrypcji.
