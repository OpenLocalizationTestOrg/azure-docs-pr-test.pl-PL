...
Więcej informacji na temat włączania rejestrowania diagnostyki dla Twojego konta usługi Data Lake Store i sposób wyświetlania dzienników zbierane dla Twojego konta.
...
3. W **diagnostycznych** bloku, wprowadź następujące zmiany, aby skonfigurować rejestrowanie diagnostyczne.
   ...
   * Istnieje możliwość magazynu/procesu dane w różny sposób.
        ...
        * Wybierz opcję **wysyłać do analizy dzienników** do analizowania danych dziennika wygenerowanych przy użyciu usługi Analiza dzienników Azure. Jeśli wybierzesz tę opcję, podaj szczegóły dla obszaru roboczego usługi Operations Management Suite użyje przeprowadzanie analizy dziennika.
...
3. Kliknij przycisk **Pobierz** łącze dla każdego wpisu dziennika do pobierania dzienników.
