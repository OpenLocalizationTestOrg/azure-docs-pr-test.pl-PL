...
Aby uzyskać instrukcje dotyczące sposobu używania fabryki danych Azure z usługą Data Lake Store, zobacz [przenoszenie danych do i z usługi Data Lake Store przy użyciu fabryki danych](../data-factory/data-factory-azure-datalake-connector.md).
