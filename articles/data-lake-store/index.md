            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p><a href="http://azure-sdk-for-python.readthedocs.io/en/latest/sample_azure-mgmt-datalake-store.html">Python (zarządzanie kontem)</a></p>
                        <p><a href="http://azure-datalake-store.readthedocs.io/en/latest">Python (zarządzanie systemem plików)</a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>REST</h3>
                        <p><a href="/rest/api/datalakestore">Interfejs API REST</a></p>
                    </div>
                </div>
            </div>
        </div>
