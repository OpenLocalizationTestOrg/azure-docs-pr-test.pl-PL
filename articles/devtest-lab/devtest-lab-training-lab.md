...
4. **Kontrolę kosztów**
   ...
   | [Usuń wszystkie laboratorium maszyn wirtualnych za pomocą skryptu programu PowerShell](devtest-lab-faq.md#how-can-i-automate-the-process-of-deleting-all-the-vms-in-my-lab) |Po zakończeniu szkolenia, należy usunąć wszystkie laboratoriów w ramach jednej operacji. |
