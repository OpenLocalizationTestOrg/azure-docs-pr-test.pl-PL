...
|Opis elementu|Ciąg|Opis interfejsu API. Nie może być pusta. Może obejmować formatowanie tagów HTML. Maksymalna długość wynosi 1000 znaków.|  
...
|Parametry|Kolekcja [parametru](#Parameter) jednostek.|Parametry, które są zdefiniowane dla tej operacji.|  
...
|Opis elementu|Ciąg|Opis parametru.|  
...
|Właściwość|Typ|Opis|  
|--------------|----------|-----------------|  
|Opis elementu|Ciąg|Opis żądania operacji.|  
|Nagłówki|Tablica [nagłówka](#Header) jednostek.|Nagłówki żądań.|  
|Parametry|Tablica [parametru](#Parameter)|Kolekcja parametrów żądania operacji.|  
...
|Opis elementu|Ciąg|Opis odpowiedzi operacji.|  
...
|Opis elementu|Ciąg|Opis operacji. Nie może być pusta. Może obejmować formatowanie tagów HTML. Maksymalna długość wynosi 1000 znaków.|  
