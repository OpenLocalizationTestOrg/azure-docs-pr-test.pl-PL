...
# <a name="expressroute-circuits-and-routing-domains"></a>Obwody usługi ExpressRoute i domeny routingu
 Należy zamówić *obwodu ExpressRoute* do podłączenia infrastruktury lokalnej do firmy Microsoft za pośrednictwem dostawcy łączności. Na poniższej ilustracji zawiera logiczną reprezentację połączenia między sieci WAN i firmy Microsoft.
...
Połączenie jest zawsze inicjowane z sieci WAN do usług Microsoft Azure. Usługi Microsoft Azure nie będą mogły inicjować połączeń do sieci za pomocą tej domeny routingu. Po włączeniu publicznej komunikacji równorzędnej, można połączyć do wszystkich usług platformy Azure. Firma Microsoft nie umożliwiają selektywne wybierz usługi, dla których firma Microsoft anonsować tras. Możesz przejrzeć listę prefiksów możemy anonsowania użytkownikowi za pomocą komunikacji równorzędnej [zakresów IP centrum danych Microsoft Azure](http://www.microsoft.com/download/details.aspx?id=41653) strony. Strona jest aktualizowana co tydzień.
...
Łączność z wszystkie inne usługi online firmy Microsoft (takich jak usługi Office 365) będzie za pomocą komunikacji równorzędnej firmy Microsoft. Firma Microsoft Włącz dwukierunkowej łączności między usług w chmurze firmy Microsoft i WAN za pośrednictwem domeny routingu komunikacji równorzędnej firmy Microsoft. Wymagane jest połączenie z usługi w chmurze firmy Microsoft tylko w przypadku publicznych adresów IP, które należą do firmy przez użytkownika lub dostawcą połączenia i musi być zgodne zdefiniowanych reguł. Zobacz [wymagania wstępne usługi ExpressRoute](expressroute-prerequisites.md) strony, aby uzyskać więcej informacji.
