---
title: "aaaAzure bezpieczeństwa usług i technologii | Dokumentacja firmy Microsoft"
description: "Artykuł Hello zawiera listę wyselekcjonowanych technologii i usług zabezpieczeń Azure."
services: security
...
W naszych rozmów z aktualnych i przyszłych klientów platformy Azure jest firma Microsoft często zadawane "masz listę wszystkich hello zabezpieczeń związane z usług i technologii, że Azure ma toooffer?"

Rozumiemy, że podczas oceniania techniczne opcje dostawcy usług chmury, jest przydatne toohave listę dostępnych, których można używać toodig dół głębiej gdy czas hello jest odpowiednie dla Ciebie.

Oto Hello dążenia początkowej zapewnienie listy. Wraz z upływem czasu tej listy zmieniać i powiększać, podobnie jak Azure. Lista Hello jest skategoryzowany i hello lista kategorii również będzie rosnąć wraz z upływem czasu. Upewnij się toocheck tę stronę na toostay regularnie na naszych usług związanych z zabezpieczeniami i technologii aktualnego.
...
* [Kontrola dostępu oparta na roli Azure](../active-directory/role-based-access-control-configure.md)
* [Azure Active Directory](../active-directory/active-directory-whatis.md)
* [Azure Active Directory B2C](../active-directory-b2c/active-directory-b2c-get-started.md)
* [Usługi domenowe Azure Active Directory](../active-directory-domain-services/active-directory-ds-overview.md)
