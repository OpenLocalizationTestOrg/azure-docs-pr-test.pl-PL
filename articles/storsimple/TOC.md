...
#### [Instalowanie najnowszej aktualizacji](storsimple-virtual-array-install-update-06.md)
##### [Instalowanie aktualizacji Update 0.5](storsimple-virtual-array-install-update-05.md)
...
## Informacje o wersji
### [Update 0.6 — bieżąca](storsimple-virtual-array-update-06-release-notes.md)
...
#### [Przegląd specyfikacji technicznej](storsimple-8000-technical-specifications-and-compliance.md)
#### [Poznawanie ograniczeń](storsimple-8000-limits.md)
#### [Najlepsze praktyki](https://gallery.technet.microsoft.com/Azure-StorSimple-8000-72b01b68)


### Instalowanie
#### [Przegląd zabezpieczeń](storsimple-8000-safety.md)
...
##### [Zmienianie trybu urządzenia](storsimple-8000-device-modes.md)
##### [Zmienianie hasła urządzenia](storsimple-8000-change-passwords.md)
##### [Modyfikowanie konfiguracji urządzenia](storsimple-8000-modify-device-config.md)
##### [Włączanie i wyłączanie](storsimple-turn-device-on-or-off.md)
##### [Konfigurowanie wielościeżkowego wejścia/wyjścia na hoście systemu Windows Server](storsimple-8000-configure-mpio-windows-server.md)
##### [Konfigurowanie wielościeżkowego wejścia/wyjścia na hoście z systemem Linux](storsimple-configure-mpio-on-linux.md)
##### [Konfigurowanie protokołu CHAP](storsimple-8000-configure-chap.md)


#### [Używanie programu Windows PowerShell dla usługi StorSimple](storsimple-8000-windows-powershell-administration.md)
##### [Zarządzanie kontrolerem urządzeń](storsimple-8000-manage-device-controller.md)
...
### Monitorowanie
#### [Using service summary (Korzystanie z podsumowania usługi)](storsimple-8000-service-dashboard.md)
#### [Using device summary (Korzystanie z podsumowania urządzenia)](storsimple-8000-device-dashboard.md)
#### [Korzystanie z wykresów monitorowania](storsimple-8000-monitor-device.md)
#### [Korzystanie z alertów usług](storsimple-8000-manage-alerts.md)
#### [Korzystanie ze stanu sprzętu](storsimple-8000-monitor-hardware-status.md)
#### [Korzystanie z diod LED monitorowania](storsimple-monitoring-indicators.md)


### Rozwiązywanie problemów
#### [Problemy z wdrażaniem](storsimple-8000-troubleshoot-deployment.md)
...
#### [Wymiana sprzętu](storsimple-8000-hardware-component-replacement.md)
##### [Wymiana kontrolera urządzeń](storsimple-8000-controller-replacement.md)
##### [Wymiana kontrolera EBOD](storsimple-8000-ebod-controller-replacement.md)
##### [Wymiana modułu PCM](storsimple-8000-power-cooling-module-replacement.md)
##### [Wymiana dysku](storsimple-8000-disk-drive-replacement.md)
##### [Wymiana baterii zapasowej](storsimple-8000-battery-replacement.md)
##### [Wymiana obudowy](storsimple-8000-chassis-replacement.md)
#### [Kontakt z pomocą techniczną](storsimple-8000-contact-microsoft-support.md)
...
#### [Instalowanie aktualizacji Update 4](storsimple-8000-install-update-4.md)


## Informacje o wersji
### [Update 5 — bieżąca](storsimple-update5-release-notes.md)
