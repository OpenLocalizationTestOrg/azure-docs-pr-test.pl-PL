...
3. Toohelp pojawi się Kreator instalacji skonfiguruj hello dane 0 interfejsu urządzenia. Podanie nowej wartości hello adres IP, bramy i maski podsieci.

> [!NOTE]
> Witaj, stałe adresy IP, należy ponownie skonfigurować za pomocą hello toobe kontrolerów **ustawień sieciowych** bloku hello urządzenia StorSimple w hello portalu Azure. Aby uzyskać więcej informacji, przejdź zbyt[zmodyfikować interfejsów sieciowych](storsimple-8000-modify-device-config.md#modify-network-interfaces).
...
* Interfejsy sieciowe tooconfigure inne niż dane 0, można użyć hello [skonfigurować ustawienia sieciowe w portalu Azure hello](storsimple-8000-modify-device-config.md). 
