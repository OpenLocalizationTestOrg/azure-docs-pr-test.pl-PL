...
urządzenie StorSimple Hello ma dwa 240 100 wentylator podwójne, zgodne SBB Power chłodzenia modułów (PCMs). Zapewnia to konfiguracji nadmiarowy. W przypadku niepowodzenia PCM urządzenia hello kontynuuje działanie toooperate na powitania zastępuje inne PCM dopóki hello modułu nie powiodło się.  
...
Wszystko jest teraz gotowy toodeploy urządzenia StorSimple w centrum danych. Aby uzyskać więcej informacji, zobacz [wdrażanie lokalnego urządzenia](storsimple-deployment-walkthrough-u2.md).  
