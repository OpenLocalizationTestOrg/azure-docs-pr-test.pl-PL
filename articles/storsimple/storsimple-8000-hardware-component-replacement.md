...
|:--- |:--- |:--- |:--- |
| Podstawa montażowa |1 |Nie |[Zastąp podstawę hello na urządzeniu StorSimple](storsimple-8000-chassis-replacement.md) |
...
| Kopia zapasowa baterii |2 |Tak |[Zastąp hello modułu baterii kopii zapasowych w urządzeniu StorSimple](storsimple-8000-battery-replacement.md) |
...
Sprawdź [skontaktuj się z Microsoft Support](storsimple-8000-contact-microsoft-support.md) tooorder żadnego z tych jednostek zastąpienia.
