...
---
# <a name="supported-hardware-for-hello-10-gbe-network-interfaces-on-your-storsimple-device"></a>Sprzętu obsługiwanego przez hello 10 GbE interfejsy na urządzeniu StorSimple
...
Firma Microsoft przetestowała powitania po małych obudowie podłączane odbiorcze (SFP), kabli i przełączników tooensure ich optymalnie działanie z urządzeniami. (hello następujące tabele zostaną zaktualizowane, jak nowy sprzęt jest testowana.)
...
## <a name="list-of-devices-tested-in-hello-field"></a>Lista urządzeń testowane w polu hello
Ta sekcja zawiera listę hello urządzeń, które zostały pomyślnie wdrożone w polu hello przez klientów StorSimple. Te nie zostały one przetestowane przez firmę Microsoft, ale są prawdopodobnie toowork na urządzeniu StorSimple.
...
Mellanox przetestowała powitania po małych obudowie podłączane odbiorcze (SFP), kabli i przełączników tooensure ich optymalnie działanie z Mellanox interfejsy sieciowe, takie jak hello 10 GbE interfejsy na urządzeniu StorSimple.

### <a name="cables-and-modules-supported-by-mellanox"></a>Kabli i obsługiwane przez Mellanox modułów
Witaj poniższej tabeli wymieniono hello kabli i obsługiwane przez Mellanox modułów. Te nie zostały one przetestowane przez firmę Microsoft, ale są prawdopodobnie toowork na urządzeniu StorSimple.
...
| 8. |10 GbE |J9281B HP X242 10 GB/S |SFP + tooSFP + 1 mln bezpośredniego kabla miedzi dołączyć |HP |
...
| 27. |10 GbE |Mellanox MAM1Q00A QSA |QSFP tooSFP + karty |Technologie Mellanox |
| 28. |10 GbE |MC2309124 006 Mt |Pasywne kabel miedzi 1 x SFP + tooQSFP 10Gb/s 24awg 7m |Technologie Mellanox |
| 29. |10 GbE |MC2309124 007 Mt |Pasywne kabel miedzi 1 x SFP + tooQSFP 10Gb/s 24awg 7m |Technologie Mellanox |
| 30. |10 GbE |Mt MC2309130 003 |Pasywne kabel miedzi 1 x SFP + tooQSFP 10Gb/s 30awg 3m |Technologie Mellanox |
| 31. |10 GbE |Mt MC2309130 00A |Pasywne kabel miedzi 1 x SFP + tooQSFP 10Gb/s 30awg 0,5 m |Technologie Mellanox |
...
Witaj w poniższej tabeli wymieniono hello parametrów obsługiwanych przez Mellanox. Te nie zostały one przetestowane przez firmę Microsoft, ale są prawdopodobnie toowork na urządzeniu StorSimple.
