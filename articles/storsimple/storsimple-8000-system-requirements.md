...
| TCP 9354 |limit |WAN |Tak |port wychodzący Hello jest używany przez toocommunicate urządzenia StorSimple hello z hello usługi Menedżer StorSimple urządzenia. |
...
Witaj routingu algorytm metryki używany dla Update 2 lub nowszym można wyjaśnić w następujący sposób.
...
* kolejność Hello, w którym ruch w chmurze hello zostaną przesłane za pośrednictwem interfejsów sieciowych hello jest:
    ...
    *liczby Hello w nawiasach wskazują hello odpowiednich metryk routingu.*
...
* Alert jest zgłaszany również na urządzeniu StorSimple, po awarii adresu VIP. Aby uzyskać więcej informacji, przejdź zbyt[alertów krótkimi opisami](storsimple-8000-manage-alerts.md).
...
* Izolowanie ruchu iSCSI i chmury hello przez używania dedykowanych interfejsów sieciowych na twoim urządzeniu dostęp iSCSI i chmury. Aby uzyskać więcej informacji, zobacz temat jak zbyt[zmodyfikować interfejsów sieciowych](storsimple-8000-modify-device-config.md#modify-network-interfaces) na urządzeniu StorSimple.
...
Aby uzyskać więcej informacji na temat monitorowania i konserwowania składniki sprzętowe hello urządzenia StorSimple Przejdź zbyt[składniki sprzętowe toomonitor usługi Menedżer StorSimple urządzenia hello i stan](storsimple-8000-monitor-hardware-status.md) i [ Wymiana składników sprzętowych StorSimple](storsimple-8000-hardware-component-replacement.md).
...
* Jeśli moduł kontrolera awarią lub koniecznością wymiany, upewnij się, że hello inny moduł kontroler jest w stanie aktywnym przed wymianą hello moduł kontrolera nie powiodło się. tooverify czy kontrolera jest aktywny, przejdź zbyt[Identyfikuj hello aktywnym kontrolerze na urządzeniu](storsimple-8000-controller-replacement.md#identify-the-active-controller-on-your-device).
...
* Podczas wymiany, monitorować hello **udostępnione składniki** w hello **kondycji sprzętu** bloku hello dysków w hello dyski SSD i dysków twardych. Stan zielony wyboru wskazuje, że dyski hello są w dobrej kondycji lub OK punktu czerwony wykrzyknik wskazuje, nie powiodło się dysków SSD i HDD.
...
* Jeśli moduł EBOD obudowa kontrolera nie powiedzie się, upewnij się, że hello inny moduł kontrolera jest aktywna, przed wymianą hello modułu nie powiodło się. tooverify czy kontrolera jest aktywny, przejdź zbyt[Identyfikuj hello aktywnym kontrolerze na urządzeniu](storsimple-8000-controller-replacement.md#identify-the-active-controller-on-your-device).
* Podczas wymiany modułu EBOD kontrolera stale monitorować stan hello hello składnika hello usługi Menedżer StorSimple urządzeń po zalogowaniu się do **Monitor** > **kondycji sprzętu** .
...
* [Dowiedz się, jak toodeploy rozwiązania StorSimple](storsimple-8000-deployment-walkthrough-u2.md).
