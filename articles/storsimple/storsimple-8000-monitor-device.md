...
Usługę Menedżer StorSimple urządzenia służy do monitorowania określonych urządzeń w rozwiązaniu StorSimple. Można tworzyć niestandardowe wykresy na podstawie wydajności operacji We/Wy, wykorzystanie pojemności, przepływność sieci i metryki wydajności urządzenia i przypiąć je na pulpicie nawigacyjnym. Aby uzyskać więcej informacji, przejdź do [dostosowanie pulpitu nawigacyjnego portalu](/articles/azure-portal/azure-portal-dashboards.md).
...
Pojemność elastycznie i pozostałe jest dalsze rozbiciu woluminów warstwowych i przypiętych lokalnie. Dla każdego woluminu elastycznie pojemności i pozostałe zasoby na urządzeniu zostanie wyświetlony.
