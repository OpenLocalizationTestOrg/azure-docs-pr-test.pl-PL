...
## <a name="what-is-hello-resource-health-intended-for"></a>Co to jest hello kondycja zasobów przeznaczonych do?
...
- Niedostępne: Nie ma żadnych znanych problemów w hello platformy Azure, które mogą mieć wpływ na tego zasobu
- Niedostępne: Kondycja zasobów wykrył problemy, które wpływają na powitania zasobów
- Nieznany: Kondycja zasobu nie można określić hello kondycji zasobu, ponieważ została zatrzymana, odbieranie informacji ich dotyczących. 
...
Można przesłać żądanie obsługi z hello kondycja zasobów bloku. Nie ma potrzeby obsługi zgodą tooopen Microsoft żądanie po hello zasób jest niedostępny ponieważ zdarzenia platformy.
...
- Przejdź tooyour zasobów. W nawigacji po lewej stronie powitania, wybierz **kondycja zasobów**
- Przejdź toohello Azure Monitor bloku.  W nawigacji po lewej stronie powitania, wybierz **kondycja zasobów**.
- Otwórz hello **Pomoc i obsługa techniczna** bloku, wybierając hello znak zapytania w hello prawym górnym rogu portalu hello, a następnie wybierając **Pomoc i obsługa techniczna**. Gdy zostanie otwarty blok hello, wybierz **kondycja zasobów**

Umożliwia także hello API kondycji zasobów tooobtain informacje o kondycji hello zasobów.
...
Jest ważne toonotice tego tooprovide ukończyć widoczność zdarzeń wpływu na zasoby, kondycja zasobu również zdarzenia powierzchni opublikowane w powiadomieniach usługi i hello pulpit nawigacyjny kondycji usługi.
