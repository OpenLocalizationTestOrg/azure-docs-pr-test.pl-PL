...
* [Kondycja zasobów przeznaczenie?](#what-is-the-resource-health-intended-for)
* [Sprawdza, jakie kondycji są wykonywane przez kondycja zasobów?](#what-health-checks-are-performed-by-resource-health)
* [Co każdy stan kondycji oznacza?](#what-does-each-of-the-health-status-mean)
* [Co oznacza nieznany stan? Coś jest problem z mojej zasobów?](#what-does-the-unknown-status-mean-is-something-wrong-with-my-resource)
...
* [Jak kondycja zasobu jest inna niż powiadomienia usługi portalu Azure lub pulpit nawigacyjny kondycji usługi?](#how-is-resource-health-different-from-the-service-health-dashboard-or-the-azure-portal-service-notifications)
* [Należy uaktywnić kondycja zasobów dla każdego zasobu?](#do-i-need-to-activate-resource-health-for-each-resource)
* [Potrzebujemy umożliwiające kondycja zasobów dla mojej organizacji?](#do-we-need-to-enable-resource-health-for-my-organization)
* [Jest kondycja zasobu jest dostępny bezpłatnie?](#is-resource-health-available-free-of-charge)
* [Jakie są zalecenia, które udostępnia kondycja zasobów?](#what-are-the-recommendations-that-resource-health-provides)
...
1. Niedostępne: Nie ma żadnych znanych problemów, na platformie Azure, które mogą mieć wpływ na tego zasobu
2. Niedostępne: Kondycja zasobów wykrył problemy, które wpływają na zasób
3. Nieznany: Kondycja zasobu nie można określić kondycji zasobu, ponieważ została zatrzymana, odbieranie informacji ich dotyczących. 
...
Można przesłać żądanie obsługi z bloku kondycji zasobów. Nie są umowy pomocy technicznej z firmą Microsoft otwarcia żądania, gdy zasób jest niedostępne ponieważ zdarzenia platformy.
...
1. Przejdź do zasobu. W obszarze nawigacji po lewej stronie, kliknij przycisk **kondycja zasobów**.
2. Przejdź do bloku Azure Monitor.  W obszarze nawigacji po lewej stronie, kliknij przycisk **kondycja zasobów**.
3. Otwórz **Pomoc i obsługa techniczna** bloku, klikając znak zapytania w prawym górnym rogu portalu, a następnie wybierając **Pomoc i obsługa techniczna**. Po otwarciu bloku kliknij **kondycja zasobów**

Aby uzyskać informacje o kondycji zasobów umożliwia także kondycja zasobu interfejsu API.
...
Nie.  Kondycja zasobów platformy Azure jest dostępna w portalu Azure, bez żadnych wymagań dotyczących instalacji.
