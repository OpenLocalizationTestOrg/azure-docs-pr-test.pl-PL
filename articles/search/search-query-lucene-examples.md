...
Określ wszystkie przykłady w tym artykule **kwerendami typu = pełny** parametru i wskazujący, że pełnej składni obsługiwane przez analizator składni zapytań Lucene wyszukiwania. 
