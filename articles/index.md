...
layout: HubPage
hide_bc: True
title: aaaMicrosoft dokumentacji platformy Azure
description: "Dowiedz się, jak toobuild zaawansowanych aplikacji przy użyciu usługi w chmurze Microsoft Azure i zarządzanie nimi. Pobierz dokumentację, przykładowy kod, samouczki i wiele więcej."
...
<div id="main" class="v2">
    <div class="container">
        <h1 class="screenReader">Dokumentacja platformy Microsoft Azure</h1>
                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <span class="likeAnH3">Wprowadzenie — przewodnik dla deweloperów platformy Azure</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <span class="likeAnH3">Przewodnik dotyczący architektury aplikacji na platformie Azure</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <span class="likeAnH3">Bezpłatne szkolenie wideo firmy Pluralsight dla platformy Azure</span>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <ul class="pivots">
                        ...
                        <ul id="get-started1" class="cardsL">
                            <li>
                                <div class="container intro">
                                    <h2 class="likeAnH1">Rozpoczynanie pracy z platformą Azure</h2>
                                    <p>Zapoznaj się z najpopularniejszymi usługami, korzystając z przewodników Szybki Start, samouczków i przykładów.</p>
                                </div>
                            </li>
                            <li>
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                <h3>Wdrażanie infrastruktury</h3>
                                                <ul class="noBullet">
                                                    <li><a class="barLink" href="/azure/virtual-machines/linux/">Maszyny wirtualne z systemem Linux</a></li>
                                                    <li><a class="barLink" href="/azure/virtual-machines/windows/">Maszyny wirtualne z systemem Windows</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                ...
                                                <div>
                                                    <h4>Modele aplikacji</h4>
                                                    <ul class="noBullet">
                                                        <li><a class="barLink" href="/azure/app-service-web/">Web Apps</a></li>
                                                        <li><a class="barLink" href="/azure/azure-functions/">Funkcje bezserwerowe</a></li>
                                                        <li><a class="barLink" href="/azure/container-instances/">Container Instances</a></li>
                                                        <li><a class="barLink" href="/azure/container-service/kubernetes/">Containers with Kubernetes (Obsługa kontenerów przy użyciu rozwiązania Kubernetes)</a></li>
                                                        <li><a class="barLink" href="/azure/service-fabric/">Microservices with Service Fabric (Obsługa mikrousług przy użyciu usługi Service Fabric)</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <li>
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                <h3>Zarządzanie danymi i AI</h3>
                                                <h4>Relacyjne bazy danych</h4>
                                                <ul class="noBullet">
                                                    <li><a class="barLink" href="/azure/sql-database/">SQL Database — baza danych jako usługa</a></li>
                                                    <li><a class="barLink" href="/azure/postgresql/">PostgreSQL Database — baza danych jako usługa</a></li>
                                                    <li><a class="barLink" href="/azure/mysql/">MySQL Database — baza danych jako usługa</a></li>
                                                </ul>
                                                <h4>NoSQL</h4>
                                                <ul class="noBullet">
                                                ...
                                                <ul class="noBullet">
                                                    <li><a class="barLink" href="/azure/cognitive-services/computer-vision/">Interfejs API przetwarzania obrazów</a></li>
                                                    <li><a class="barLink" href="/azure/cognitive-services/face/">Interfejs API rozpoznawania twarzy</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <li>
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                <h3>Narzędzia wiersza polecenia</h3>
                                                <div class="cols">
                                                    <div>
                                                        <a class="barLink" href="/cli/azure/overview">
                                                            <img src="media/index/azure_dev-7.svg" alt=""> Interfejs wiersza polecenia platformy Azure</a>
                                                    </div>
                                                    <div>
                                                ...
                                                <div class="cols">
                                                    ...
                                                    <div>
                                                        <a class="barLink" href="/azure/virtual-machines/linux/tutorial-jenkins-github-docker-cicd">
                                                            <img src="https://docs.microsoft.com/en-us/media/logos/logo_jenkins.svg" alt=""> Usługa Jenkins na maszynach wirtualnych platformy Azure</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <li class="bottomRightItem">
                                ...
                                <button style="cursor: pointer;position: relative; background: #0050C5; border:none; padding:8px 16px; padding-right:30px;color: white; font-size:14px;">Wyświetl wszystkie usługi platformy Azure<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 10 14" style="fill:white;height: 14px;position: absolute;bottom: 13px;right: 12px;width: 1em;"><path d="M7.4 7L1 .6l.6-.6 7 7-7 7-.6-.7L7.4 7z"/></svg></button>
                                </a>
                            </li>
                            </li>
                        </ul>
            ...
            <li>
                ...
                <ul id="services">
                        ...
                        <ul id="all" class="directory">
                            <li>
                                <div class="group">
                                    ...
                                    <h3>Integracja dla przedsiębiorstw</h3>
                                    <ul>
                                        <li>
                                    ...
                                    <ul>
                                        <li>
                                            <a href="/azure/azure-government/">
                                                ...
                                                <p>Wersja platformy Azure dla administracji USA</p>
                                            </a>
                                        </li>
                                        <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/load-balancer/">
                                                ...
                                                <p>Moduł równoważenia obciążenia</p>
                                            </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="/azure/dns/">
                                                ...
                                                <p>System DNS platformy Azure</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/cdn/">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/cognitive-services/speaker-recognition/home">
                                                ...
                                                <p>Rozpoznawanie osoby mówiącej</p>
                                            </a>
                                        </li>
                                        <li>
                            ...
                            <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="https://docs.botframework.com/en-us/azure-bot-service/">
                                                ...
                                                <p>Usługa Azure Bot</p>
                                            </a>
                                        </li>
                                    </ul>
                                    <h3>Narzędzia deweloperskie</h3>
                                    <ul>
                                        <li>
                                ...
                                <div class="group">
                                    <h3>Sieć Web + aplikacje mobilne</h3>
                                    <ul>
                                        <li>
                                    ...
                                    <h3>Bezpieczeństwo i obsługa tożsamości</h3>
                                    <ul>
                                        <li>
                                        ...
                                        <li>
                                            <a href="/azure/security/">
                                                <img src="media/index/SecurityCenter.svg" alt="" />
                                                <p>Informacje o zabezpieczeniach</p>
                                            </a>
                                        </li>
                                    </ul>
                    ...
                    <li>
                        <a data-default="true" href="#Compute">Obliczanie</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Maszyny wirtualne z systemem Linux</h3>
                                                    <p>Aprowizacja maszyn wirtualnych z systemami Ubuntu, Red Hat i innymi</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Maszyny wirtualne z systemem Windows</h3>
                                                    <p>Aprowizacja maszyn wirtualnych z oprogramowaniem SQL Server, SharePoint i innym</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Zarządzanie i skalowanie 10s too1000s maszyn wirtualnych systemu Linux i Windows</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Web Apps</h3>
                                                    <p>Szybkie tworzenie i wdrażanie aplikacji sieci Web o kluczowym znaczeniu w odpowiedniej skali</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Funkcje</h3>
                                                    <p>Przetwarzanie zdarzeń przy użyciu kodu bez serwera</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Batch</h3>
                                                    <p>Planowanie zadań i zarządzanie wystąpieniami obliczeniowymi w skali chmury</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Tworzenie mikrousług i aranżowanie kontenerów w systemach Windows lub Linux</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Tworzenie nieskończenie skalowalnych aplikacji w chmurze oraz interfejsów API o wysokiej dostępności</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Omówienie sieci</h3>
                                                    <p>Zintegrowany widok hello sieci usługi na platformie Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Udostępnianie w sieciach prywatnych, opcjonalnie Połącz tooon lokalnych centrów danych</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Moduł równoważenia obciążenia</h3>
                                                    <p>Dostarczanie wysokiej dostępności i wydajnością sieci tooyour aplikacji</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Moduł równoważenia obciążenia warstwy 7 z wbudowanym równoważeniem obciążenia HTTP i kontrolą dostarczania</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>VPN Gateway</h3>
                                                    <p>Ustanawianie bezpiecznej łączności między środowiskami lokalnymi</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>System DNS platformy Azure</h3>
                                                    <p>Hostowanie domeny systemu DNS na platformie Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>CDN</h3>
                                                    <p>Dostarczanie zawartości użytkowników tooend za pośrednictwem niezawodnych sieci centrów danych globalnych </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>ExpressRoute</h3>
                                                    <p>TooAzure połączeń fiber dedykowanej sieci prywatnej</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Magazyn</h3>
                                                    <p>Niezawodny magazyn danych w chmurze o wysokim stopniu dostępności i skalowalności</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Proste i niezawodne serwera kopii zapasowej toohello chmury</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#web">Sieć Web + aplikacje mobilne</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Mobile Apps</h3>
                                                    <p>Kompilowanie i hosta hello wewnętrznej bazy danych dla dowolnej aplikacji mobilnej</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>API Apps</h3>
                                                    <p>Proste tworzenie i używanie interfejsów API chmury</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Logic Apps</h3>
                                                    <p>Automatyzowanie hello dostępu i użycia danych w chmurze bez pisania kodu</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Kodowanie, przechowywanie oraz przesyłanie strumieniowe wideo i audio w dowolnej skali</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Zwiększone użycie aplikacji i wyższy wskaźnik utrzymania użytkowników</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Skalowanie i koordynacja kontenerów przy użyciu systemu operacyjnego DC/OS albo rozwiązania Kubernetes lub Docker Swarm</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Przechowywanie obrazów kontenerów i zarządzanie nimi w różnych typach wdrożeń platformy Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Łatwe uruchamianie kontenerów za pomocą jednego polecenia</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#databases">Bazy danych</a>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Dynamiczne rozciąganie tooAzure baz danych programu SQL Server lokalne</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>PostgreSQL</h3>
                                                    <p>Zarządzane usługą bazy danych PostgreSQL dla deweloperów aplikacji</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>MySQL</h3>
                                                    <p>Zarządzanie usługą bazy danych MySQL dla deweloperów aplikacji</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Wysokiej przepływności, toobuild fast/skalowalnych aplikacji dostępu do danych o małych opóźnieniach</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Fabryka danych</h3>
                                                    <p>Organizowanie przekształcania i przenoszenia danych oraz zarządzanie tymi operacjami</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Przetwarzanie obrazów</h3>
                                                    <p>Wyodrębnianie określonych informacji z obrazów</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Rozpoznawanie twarzy</h3>
                                                    <p>Wykrywanie, identyfikowanie, analizowanie, organizowanie i tagowanie twarzy na zdjęciach</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Wyszukiwanie w sieci Web (Bing)</h3>
                                                    <p>Połączyć aplikacje tooyour wyszukiwania zaawansowanego w sieci web</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Pokonywanie barier związanych z rozpoznawaniem mowy</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Usługi sieci web można dostosować, który uzyskuje informacje o toorecognize zawartości określonych w obrazów</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Indeksator wideo</h3>
                                                    <p>Wyszukiwanie, edytowanie, analizowanie i uczenie się na podstawie wideo</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Uczenie aplikacji polecenia toounderstand od użytkowników</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Wyszukiwanie niestandardowe Bing</h3>
                                                    <p>Wyniki wyszukiwania hello, której poszukujesz dla kompilacji</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#analytics">Dane + analiza</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Usługa Machine Learning</h3>
                                                    <p>Analizy predykcyjnej oparte na chmurze zaawansowane narzędzia do konserwacji predykcyjnej tooenable</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Przetwarzanie strumienia danych z milionów urządzeń IoT w czasie rzeczywistym</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Data Catalog</h3>
                                                    <p>Włącz odnajdywanie źródła danych samoobsługi dla przedsiębiorstwa hello</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Rozproszona usługa analizy upraszczająca obsługę danych big data</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Osadzanie w pełni interaktywnych, atrakcyjnych wizualizacji danych w aplikacjach</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Modelowanie w chmurze hello danych korporacyjnej</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Usługa Azure Bot</h3>
                                                    <p>Inteligentna, bezserwerowa, skalowana na żądanie usługa botów</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Centrum deweloperów IoT</h3>
                                                    <p>Wprowadzenie do łączenia urządzeń</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Pakiet IoT Azure</h3>
                                                    <p>Przechwytywanie i analizowanie wyników biznesowych tooimprove ich danych</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Usługa Event Hubs</h3>
                                                    <p>Odbieranie danych telemetrycznych z milionów urządzeń</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Natychmiastowe badanie i analizowanie danych szeregów czasowych</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#integration">Integracja dla przedsiębiorstw</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Service Bus</h3>
                                                    <p>Nawiązywanie połączeń między środowiskami chmur prywatnych i publicznych</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Publikowanie toodevelopers interfejsów API, partnerzy i pracownicy bezpiecznie i na dużą skalę</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Bezproblemowe integrowanie hello enterprise i hello chmury</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#security">Bezpieczeństwo i obsługa tożsamości</a>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Zapobiegania, wykrywania i odpowie toothreats lepszy wgląd</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Dowiedz się, jak toomanage kluczy kryptograficznych i kluczy tajnych</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Usługa Azure Active Directory</h3>
                                                    <p>Synchronizowanie katalogów lokalnych i włączanie logowania jednokrotnego</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Zarządzania tożsamościami i dostępem w chmurze powitania klienta</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Przyłączenia domeny tooa maszyn wirtualnych platformy Azure bez kontrolerów domeny</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Zabezpieczenie dostępu tooyour danych i aplikacji dzięki dodatkowemu poziomowi uwierzytelniania</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Informacje o zabezpieczeniach</h3>
                                                    <p>Dowiedz się, jak platforma Azure udostępnia bezpieczną infrastrukturę toobuild rozwiązań w chmurze</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Usługi dla zespołów tooshare kod, śledzić pracę i dostarczać oprogramowanie</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Szybkie tworzenie środowisk przy użyciu szablonów i artefaktów wielokrotnego użycia</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Wykrywanie, klasyfikowanie i diagnozowanie problemów z usługami i aplikacjami sieci Web</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>HockeyApp</h3>
                                                    <p>Wdrażanie aplikacji mobilnych, gromadzenie opinii i raportów o awariach oraz monitorowanie użycia</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#mgmt">Monitorowanie i zarządzanie</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Log Analytics</h3>
                                                    <p>Dowiedz się, jak tootransform maszyny danych do analizy operacyjne</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Automatyzacja</h3>
                                                    <p>Uproszczenie zarządzania chmurą dzięki automatyzacji procesów</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure Monitor</h3>
                                                    <p>Bardzo szczegółowe dane monitorowania w czasie rzeczywistym dla dowolnych zasobów platformy Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Rozliczenia</h3>
                                                    <p>Dowiedz się, jak tooread/zrozumieć hello użycia i Kwota rachunku dla subskrypcji platformy Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure Advisor</h3>
                                                    <p>Poprawa hello koszt skuteczności, wydajność, wysoką dostępność i zabezpieczeń zasobów platformy Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Skorzystaj z niezawodnego dostarczania zdarzeń na wielką skalę</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Wersja platformy Microsoft Azure dla administracji USA</h3>
                                                    <p>Tworzenie i hostowanie aplikacji na potrzeby administracji USA w dedykowanym wystąpieniu platformy Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Dostarczanie usług platformy Azure z własnego centrum danych za pomocą nowej platformy chmury hybrydowej</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <ul id="sdkstools">
                    <li>
                        ...
                        <ul id="sdkstools-all" class="cardsF">
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
                                                    <a href="/dotnet/azure/dotnet-sdk-azure-install">Pobierz hello bibliotek platformy Azure dla platformy .NET</a>
                                                </h3>
                                                <p>
                                                    <a href="/dotnet/azure">Wprowadzenie</a>
                                                </p>
                                                <p>
                                                    <a href="/dotnet/api/overview/azure/?view=azure-dotnet">Dokumentacja interfejsu API</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
                                                    <a href="/python/azure/python-sdk-azure-install">Pobierz hello bibliotek platformy Azure dla języka Python</a>
                                                </h3>
                                                <p>
                                                    <a href="/python/azure">Wprowadzenie</a>
                                                </p>
                                                <p>
                                                    <a href="/python/api/overview/azure/">Dokumentacja interfejsu API</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
                                                    <a href="/nodejs/azure/node-sdk-azure-install">Pobierz hello bibliotek platformy Azure dla środowiska Node.js</a>
                                                </h3>
                                                <p>
                                                    <a href="/nodejs/azure/?view=azure-node-2.0.0">Wprowadzenie</a>
                                                </p>
                                                <p>
                                                    <a href="/nodejs/api/overview/azure">Dokumentacja interfejsu API</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
                                                    <a href="/java/azure/java-sdk-azure-install">Pobierz hello bibliotek platformy Azure dla języka Java</a>
                                                </h3>
                                                <p>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
                                                    <a href="https://rubygems.org/gems/azure">Pobierz hello Ruby SDK</a>
                                                </h3>
                                                <p>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
                                                    <a href="/rest/api/">Rozpocznij pracę z technologią REST</a>
                                                </h3>
                                                <p>
                            ...
                            <li>
                                <div class="container">
                                    <h2>Interfejs wiersza polecenia</h2>
                                </div>
                            </li>
                            <li>
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Interfejs wiersza polecenia platformy Azure 2.0 </h3>
                                                <p>
                                                    <a href="/cli/azure/overview">Wprowadzenie</a>
                                                </p>
                                                <p>
                                                    <a href="/cli/azure/install-azure-cli">Pobierz interfejs wiersza polecenia platformy Azure w wersji 2.0</a>
                                                </p>
                                                <p>
                                                    <a href="/cli/azure">Dokumentacja</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>PowerShell</h3>
                                                <p>
                                                    <a href="/powershell/azure/get-started-azureps">Wprowadzenie</a>
                                                </p>
                                                <p>
                                                    <a href="/powershell/azure/install-azurerm-ps">Pobierz program PowerShell</a>
                                                </p>
                                                <p>
                                                    <a href="/powershell/azure/overview">Dokumentacja</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p>
                                                    <a href="/azure/xplat-cli-install?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json">Wprowadzenie</a>
                                                </p>
                                                <p>
                                                    <a href="http://aka.ms/linux-azure-cli">Pobierz interfejs wiersza polecenia platformy Azure dla systemu Linux</a>
                                                </p>
                                                <p>
                                                    <a href="http://aka.ms/mac-azure-cli">Pobierz interfejs wiersza polecenia platformy Azure dla komputerów Mac</a>
                                                </p>
                                                <p>
                                                    <a href="http://aka.ms/webpi-azure-cli">Pobierz interfejs wiersza polecenia platformy Azure dla systemu Windows</a>
                                                </p>
                                                <p>
                                                    <a href="/azure/virtual-machines/azure-cli-arm-commands?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json">Dokumentacja</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <li>
                                <div class="container">
                                    <h2>Narzędzia i rozszerzenia</h2>
                                </div>
                            </li>
                            <li>
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
                                                    <a href="https://www.visualstudio.com/vs/azure-tools/">Narzędzia Visual Studio Tools dla platformy Azure</a>
                                                </h3>
                                                <p>
                                                    <a href="https://www.microsoft.com/web/handlers/webpi.ashx/getinstaller/VWDOrVs2015AzurePack.appids">Pobierz</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
                                                    <a href="https://github.com/Microsoft/DockerToolsDocs">Narzędzia platformy Docker</a>
                                                </h3>
                                                <p>
                                                    <a href="/dotnet/articles/core/docker/visual-studio-tools-for-docker">Wprowadzenie</a>
                                                </p>
                                                <p>
                                                ...
                                                <p>
                                                    <a href="https://go.microsoft.com/fwlink/?LinkId=780682">Pobierz dla usługi Team Services</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
                                                    <a href="https://visualstudiogallery.msdn.microsoft.com/c9eb3ba8-0c59-4944-9a62-6eee37294597">Narzędzia programu PowerShell dla programu Visual Studio</a>
                                                </h3>
                                                <p>
                                                    <a href="https://visualstudiogallery.msdn.microsoft.com/c9eb3ba8-0c59-4944-9a62-6eee37294597">Pobierz</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p>
                                                    <a href="/azure/vs-azure-tools-storage-manage-with-storage-explorer">Wprowadzenie</a>
                                                </p>
                                                <p>
                                                     <a  href="http://go.microsoft.com/fwlink/?LinkId=722418">Pobierz dla systemu Linux</a>
                                                </p>
                                                <p>
                                                    <a href="http://go.microsoft.com/fwlink/?LinkId=708342">Pobierz dla komputerów Mac</a>
                                                </p>
                                                <p>
                                                    <a href="http://go.microsoft.com/fwlink/?LinkId=708343">Pobierz dla systemu Windows</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                ...
                <ul id="architecture">
                    <li>
                        ...
                        <ul id="architecture1" class="cardsC">
                            <li>
                                <div class="container intro">
                                    <p>Zestaw zalecanych architektur dla aplikacji w chmurze. Każdej architektury zawiera zalecane praktyki, przetestowanego kroki i składnik pliku wykonywalnego, który zawiera zalecenia hello.</p>
                                </div>
                            </li>
                            <li>
                                <a href="/azure/architecture/guide/">
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Toobe podstawowej wiedzy powiodło się w chmurze hello. W przypadku nowych chmury toohello lub tooAzure nowe, zacznij tutaj.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Architektury referencyjne</h3>
                                                    <p>Zbiór zalecanych architektury chmury hello. Każda architektura zawiera najlepsze rozwiązania, normatywne kroki i możliwe do wdrożenia rozwiązanie.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Projektowanie wzorce hello chmury. Każdy wzorzec opis problemu, wzorzec, który adresy hello problem i przykład oparte na platformie Azure.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Zestaw najlepszych rozwiązań dla aplikacji w chmurze, który obejmuje takie aspekty, jak skalowanie automatyczne, buforowanie, partycjonowanie danych, projektowanie interfejsu API i monitorowanie.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
