...
Witaj użycie [oparta na urządzeniach certyfikatu X.509] [ lnk-protocols] i jego skojarzony prywatnych i publicznych pary kluczy umożliwia dodatkowe uwierzytelnianie w warstwie fizycznej hello. klucz prywatny Hello jest bezpiecznie przechowywana w hello urządzenia i nie jest wykrywalny poza hello urządzenia. Certyfikat X.509 Hello zawiera informacje o urządzeniu hello, takich jak identyfikator urządzenia i inne szczegóły organizacji. Podpis certyfikatu hello jest generowany przy użyciu klucza prywatnego hello.
