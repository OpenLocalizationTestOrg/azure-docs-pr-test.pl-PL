...
#### [Użyj hello Hive View](hdinsight-hadoop-use-hive-ambari-view.md)
...
#### [Użyj hello HDInsight tools for Visual Studio](hdinsight-hadoop-use-hive-visual-studio.md)
#### [Korzystanie z pulpitu zdalnego](hdinsight-hadoop-use-hive-remote-desktop.md)
#### [Użyj hello konsoli zapytania](hdinsight-hadoop-use-hive-query-console.md)
...
### [Uruchom hello MapReduce próbek](hdinsight-hadoop-run-samples-linux.md)
...
#### [Użyj hello zestawu .NET SDK](hdinsight-hadoop-use-pig-dotnet-sdk.md)
...
#### [Zapis tooData Lake — Magazyn](hdinsight-storm-write-data-lake-store.md)
...
### [Korzystanie z aplikacji Spark toocreate narzędzi HDInsight Tools](hdinsight-apache-spark-eclipse-tool-plugin.md)
### [Korzystanie z aplikacji Spark toodebug narzędzi HDInsight Tools zdalnie za pośrednictwem SSH](hdinsight-apache-spark-intellij-tool-debug-remotely-through-ssh.md)
...
### [Połącz Excel tooHadoop](hdinsight-connect-excel-hive-odbc-driver.md)
### [Połącz, używając sterownik Hive JDBC hello](hdinsight-connect-hive-jdbc-driver.md)
...
### [Połączyć sieć lokalną tooyour HDInsight](connect-on-premises-network.md)
...
#### [Korzystanie z aplikacji tooinstall REST](https://msdn.microsoft.com/library/mt706515.aspx)
#### [Publikowanie tooAzure aplikacje usługi HDInsight Marketplace](hdinsight-apps-publish-applications.md)
## Bezpieczeństwo
...
### [Ograniczanie dostępu toodata](hdinsight-storage-sharedaccesssignature-permissions.md)
## Zarządzanie
...
#### [Użyj cURL i hello interfejsu API REST Azure](hdinsight-hadoop-create-linux-clusters-curl-rest.md)
#### [Użyj hello zestawu .NET SDK](hdinsight-hadoop-create-linux-clusters-dotnet-sdk.md)
#### [Użyj hello wiersza polecenia platformy Azure](hdinsight-hadoop-create-linux-clusters-azure-cli.md)
#### [Użyj hello portalu Azure](hdinsight-hadoop-create-linux-clusters-portal.md)
...
#### [Użyj hello wiersza polecenia platformy Azure](hdinsight-administer-use-command-line.md)
### [Zarządzanie przy użyciu hello Ambari web UI](hdinsight-hadoop-manage-ambari.md)
...
### [Narzędzia deweloperskie tooResource Menedżera migracji](hdinsight-hadoop-development-using-azure-resource-manager.md)
### [Dostępność i niezawodność](hdinsight-high-availability-linux.md)
### [Uaktualnienie wersji toonewer klastra usługi HDInsight](hdinsight-upgrade-cluster.md)
...
### [YARN troubleshooting (Rozwiązywanie problemów z platformą YARN)](hdinsight-troubleshoot-yarn.md)
### Zasoby
...
#### [Użyj widoków Ambari toodebug Tez zadania](hdinsight-debug-ambari-tez-view.md)
...
### [Migrowanie klastrów tooLinux klastrów systemu Windows](hdinsight-migrate-from-windows-to-linux.md)
### [Migrowanie klastrów tooLinux rozwiązań platformy .NET](hdinsight-hadoop-migrate-dotnet-to-linux.md)
...
### [Użyj Giraph tooprocess dużych wykresów](hdinsight-hadoop-giraph-install.md)
...
### [Korzystanie z aplikacji Java toobuild Maven](hdinsight-hbase-build-java-maven.md)
### [Użyj hello interfejsu użytkownika aplikacji Tez toodebug Tez zadania](hdinsight-debug-tez-ui.md)
...
### [Monitorowanie klastrów za pomocą hello Ambari API](hdinsight-monitor-use-ambari-api.md)

# Zasoby
## [Harmonogram działania dla platformy Azure](https://azure.microsoft.com/roadmap/?category=intelligence-analytics)
## [Uzyskaj pomoc na hello forum](https://social.msdn.microsoft.com/forums/azure/en-US/home?forum=hdinsight)
