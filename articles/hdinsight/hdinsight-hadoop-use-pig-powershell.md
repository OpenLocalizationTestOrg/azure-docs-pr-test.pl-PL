...
1. Za pomocą edytora, Zapisz poniższy kod jako **pigjob.ps1**.
    ...
    [!code-powershell[główne](../../powershell_scripts/hdinsight/use-pig/use-pig.ps1?range=5-51)]
...
Jeśli żadne informacje nie zostanie zwrócone, po zakończeniu zadania, może mieć wystąpił błąd podczas przetwarzania. Aby wyświetlić informacje o błędzie dla tego zadania, należy dodać następujące polecenie na końcu **pigjob.ps1** , zapisz go, a następnie uruchomić.
...
To zwraca informacje, które zostało zapisane STDERR na serwerze po uruchomieniu zadania i może pomóc ustalić, dlaczego zadanie kończy się niepowodzeniem.
