...
Zapora aplikacji sieci web dla aplikacji bramy (WAF) chroni aplikacji sieci web ze znanych luk i luk w zabezpieczeniach. Można to zrobić za pomocą reguł, które są zdefiniowane oparte na powitania OWASP podstawowe zestawy reguł 2.2.9 lub 3.0. Te reguły można wyłączyć na podstawie przez reguły. Ten artykuł zawiera hello bieżące reguły i oferowane zestawów reguł.

Witaj następujące tabele są hello grup reguł i reguł, które są dostępne podczas korzystania z bramy aplikacji z zapory aplikacji sieci web.  Każda tabela dotyczy znaleziono w grupie reguły dla określonej wersji CRS reguł hello.
...
|920130|Nie można tooparse treści żądania.|
...
|960912|Nie można tooparse treści żądania.|
...
|RuleId|Opis|
|---|---|
|990002|Żądanie wskazuje hello skanowania skanera zabezpieczeń lokacji|
|990901|Żądanie wskazuje hello skanowania skanera zabezpieczeń lokacji|
|990902|Żądanie wskazuje hello skanowania skanera zabezpieczeń lokacji|
...
Dowiedz się, jak zasady toodisable zapory aplikacji sieci Web, odwiedzając: [reguły zapory dostosowywania aplikacji sieci Web](application-gateway-customize-waf-rules-portal.md)
