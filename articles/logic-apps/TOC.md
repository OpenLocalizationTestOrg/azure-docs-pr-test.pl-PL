...
### [Batch process messages (Komunikaty przetwarzania wsadowego)](logic-apps-batch-process-send-receive-messages.md)
...
### [Monitor logic app status in OMS with Log Analytics (Monitorowanie stanu aplikacji logiki w pakiecie OMS przy użyciu usługi Log Analytics)](logic-apps-monitor-your-logic-apps-oms.md)
