...
1. Obszar zestawu — hello domyślne obwód jest, że Pi nawiązanie połączenia z czujnika BME280 i LED. obszar Hello jest zablokowany w wersji preview tak aktualnie nie może wykonać dostosowania.
2. Kodowanie obszar — edytora online kodu dla toocode z malina Pi. Hello domyślne przykładowej aplikacji ułatwia toocollect danych czujnika z czujnika BME280 i wysyła tooyour Centrum IoT Azure. Aplikacja Hello jest w pełni zgodny z rzeczywistych urządzeń Pi. 
3. Okno konsoli zintegrowane - zawiera dane wyjściowe hello kodu. U góry hello tego okna istnieją trzy przyciski.
