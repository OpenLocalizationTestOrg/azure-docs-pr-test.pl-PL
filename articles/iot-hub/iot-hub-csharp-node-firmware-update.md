...
1. W wierszu polecenia w **manageddevice** folderu, uruchom następujące polecenie Rozpoczęcie nasłuchiwania metoda bezpośrednia ponowne uruchomienie komputera.
    ...
    ```
2. W programie Visual Studio, kliknij prawym przyciskiem myszy **TriggerFWUpdate** projectRun w języku C# aplikacji konsoli, wybierz **debugowania** i **Start nowe wystąpienie**.
