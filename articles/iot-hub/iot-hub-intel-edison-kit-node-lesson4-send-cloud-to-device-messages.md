...
1. Upewnij się, że jesteś w folderze repozytorium hello `iot-hub-node-edison-getting-started`. Otwórz hello przykładowej aplikacji w programie Visual Studio Code, uruchamiając następujące polecenia hello:
