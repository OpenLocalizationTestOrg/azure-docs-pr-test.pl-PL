...
* Środowisko Node.js w wersji 0.12.x lub nowszej. Artykuł [przygotowywanie środowiska projektowego] [ lnk-dev-setup] opisuje sposób instalowania programu Node.js w tym samouczku w systemie Windows lub Linux.
