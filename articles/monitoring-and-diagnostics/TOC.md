...
### [Alert metryki wywołujący element webhook](insights-webhooks-alerts.md)
...
### [Najlepsze praktyki](insights-autoscale-best-practices.md)
### [Często używane metryki](insights-autoscale-common-metrics.md)
### [Często używane wzorce](monitoring-autoscale-common-scale-patterns.md)
...
## Użyj dziennika aktywności hello
### [Wyświetlanie zdarzeń w dzienniku aktywności](../azure-resource-manager/resource-group-audit.md?toc=%2fazure%2fmonitoring-and-diagnostics%2ftoc.json)
...
### [Strumień działania dziennika tooEvent koncentratory](monitoring-stream-activity-logs-event-hubs.md)
...
### [Migrowanie tooActivity dziennika alertów](monitoring-migrate-management-alerts.md)
...
### [Strumień tooEvent koncentratory](monitoring-stream-diagnostic-logs-to-event-hubs.md)
...
## Witaj Użyj interfejsu API REST
...
### [Wyślij tooApplication Insights](azure-diagnostics-configure-application-insights.md)
### [Wyślij tooEvent koncentratory](azure-diagnostics-streaming-event-hubs.md)
### [Rozwiązywanie problemów](azure-diagnostics-troubleshooting.md)

# Dokumentacja
## [Przykłady kodu](https://azure.microsoft.com/en-us/resources/samples/?service=monitor)
## [Źródła danych monitorowania](monitoring-data-sources.md)
## [Lista obsługiwanych metryk](monitoring-supported-metrics.md)
## [Activity Log event schema (Schemat zdarzeń dziennika aktywności)](monitoring-activity-log-schema.md)
## [Obsługiwane usługi, kategorie i schematy dla dzienników diagnostycznych](monitoring-diagnostic-logs-schema.md)
