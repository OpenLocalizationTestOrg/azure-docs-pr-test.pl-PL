...
Należy pamiętać, że aplikacje sieci Web nie diagnostyki Azure. Znajdź równoważnych informacji w [aplikacji sieci Web](../app-service-web/web-sites-enable-diagnostic-log.md)
