...
| Dzienniki usługi aplikacji | Zdarzenia | Usługi aplikacji | <ul><li>**Plik, tabeli lub magazynu obiektów blob:** [sieci Web diagnostyki aplikacji](../app-service-web/web-sites-enable-diagnostic-log.md)</li></ul> |
