...
## [Użyj programu PowerShell toomanage Menedżera ruchu](traffic-manager-powershell-arm.md)
## [Wskaż sieci Internet domeny tooTraffic Manager](traffic-manager-point-internet-domain.md)
