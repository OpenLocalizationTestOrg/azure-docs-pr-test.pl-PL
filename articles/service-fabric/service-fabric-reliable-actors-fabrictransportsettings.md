...
Poniżej przedstawiono ustawienia hello, które można skonfigurować:
...
Można zmodyfikować domyślną konfigurację hello FabricTransport w następujący sposób.

## <a name="assembly-attribute"></a>Atrybut zestawu

Witaj [FabricTransportActorRemotingProvider](https://docs.microsoft.com/en-us/dotnet/api/microsoft.servicefabric.actors.remoting.fabrictransport.fabrictransportactorremotingproviderattribute?redirectedfrom=MSDN#microsoft_servicefabric_actors_remoting_fabrictransport_fabrictransportactorremotingproviderattribute) atrybut wymaga toobe zastosowane na powitania aktora klienta i aktora zestawy usług.

Witaj poniższy przykład pokazuje, jak toochange hello wartość domyślną ustawienia FabricTransport OperationTimeout:
...
Można użyć [pakietu konfiguracji](service-fabric-application-model.md) toomodify hello domyślnej konfiguracji.

### <a name="configure-fabrictransport-settings-for-hello-actor-service"></a>Skonfiguruj ustawienia FabricTransport dla usługi aktora hello

Dodaj sekcję TransportSettings w pliku settings.xml hello.
...
### <a name="configure-fabrictransport-settings-for-hello-actor-client-assembly"></a>Skonfiguruj ustawienia FabricTransport hello aktora klienta zestawu

Jeśli powitania klienta nie jest uruchomiony jako część usługi, możesz utworzyć "&lt;nazwa Exe klienta&gt;. settings.xml" w pliku hello sam lokalizacji co plik .exe powitania klienta. Następnie dodaj sekcję TransportSettings w tym pliku. SectionName powinien być "TransportSettings".
  ...
  * Konfigurowanie ustawień FabricTransport dla klienta usługi aktora bezpiecznego za pomocą dodatkowego certyfikatu.
  ...
  Poniżej znajduje się przykład hello hello TransportSettings odbiornika.
    ...
    <Parameter Name="CertificateProtectionLevel" Value="EncryptAndSign" />
     ...
     ```
     Poniżej znajduje się przykład hello hello TransportSettings klienta.
    ...
    * Konfigurowanie ustawień FabricTransport zabezpieczania aktora/klient usługi za pomocą nazwy podmiotu.
    Użytkownik musi tooprovide findType jako FindBySubjectName, Dodaj CertificateIssuerThumbprints i CertificateRemoteCommonNames wartości.
  Poniżej znajduje się przykład hello hello TransportSettings odbiornika.
