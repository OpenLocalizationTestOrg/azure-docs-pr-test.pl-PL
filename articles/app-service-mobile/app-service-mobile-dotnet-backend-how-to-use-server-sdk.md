...
W tej sekcji przedstawiono sposób publikowania projektu zaplecza .NET z programu Visual Studio. Można także wdrożyć projektu zaplecza przy użyciu narzędzia Git lub innych metod opisanych w [dokumentacja wdrażania usługi aplikacji Azure](../app-service-web/web-sites-deploy.md).
...
5. Pobierz i ocenić dzienniki, zgodnie z opisem w [porady: pobieranie dzienników](../app-service-web/web-sites-enable-diagnostic-log.md#download).
