...
Azure AD Identity Protection wysyła dwa rodzaje automatycznych powiadomień wiadomości e-mail toohelp, którymi można zarządzać ryzykiem użytkownika i zdarzenia ryzyka:
...
1. Na powitania **Azure AD Identity Protection** bloku, kliknij przycisk **ustawienia**.
   <br><br>
   ![Zasady użytkownika ryzyka](./media/active-directory-identityprotection-notifications/401.png "zasad ryzyka użytkownika")
   <br>
2. W hello **ogólne** kliknij **powiadomienia**.
   <br><br>
