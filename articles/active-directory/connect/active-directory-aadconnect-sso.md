...
>[!IMPORTANT]
>Bezproblemowe rejestracji Jednokrotnej jest obecnie w przeglądzie. Ta funkcja jest _nie_ mające zastosowanie do Active Directory Federation Services (ADFS).
