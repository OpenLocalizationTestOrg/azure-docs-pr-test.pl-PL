...
Przy użyciu zadań, które są dostępne w programie Azure AD Connect po początkowej konfiguracji programu Azure AD Connect przy użyciu kreatora można zmienić metody logowania użytkownika z federacyjnego, synchronizacja haseł lub uwierzytelnianie przekazywane. Uruchom ponownie Kreatora programu Azure AD Connect i zobaczysz listę zadań, które można wykonywać. Wybierz **zmienić logowania użytkownika** z listy zadań.
...
> [!NOTE]
> Jeśli tworzysz tylko tymczasowego przełącznika do synchronizacji haseł, następnie wybierz **kont użytkowników nie można konwertować** pole wyboru. Nie sprawdza opcję przekonwertuje każdego użytkownika federacyjnego, a może zająć kilka godzin.
>
>
