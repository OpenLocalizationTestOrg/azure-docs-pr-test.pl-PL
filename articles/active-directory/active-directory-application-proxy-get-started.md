...
Co aplikacja została opublikowana z serwerem Proxy aplikacji, można nim zarządzać jak każda inna aplikacja przedsiębiorstwa w portalu Azure. Można za pomocą funkcji zabezpieczeń usługi Azure Active Directory, takie jak warunkowego dostępu i dwuetapowej weryfikacji, kontrolować uprawnienia użytkowników i Dostosuj znakowanie dla aplikacji. 
