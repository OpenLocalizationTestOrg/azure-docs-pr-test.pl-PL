...
> * [Witryna Azure Portal](active-directory-assign-admin-roles-azure-portal.md)
> * [Klasyczna witryna Azure Portal](active-directory-assign-admin-roles.md)
>
>

Za pomocą usługi Azure Active Directory (Azure AD), można określić osobne Administratorzy tooserve różne funkcje. Administratorzy będą mieć dostęp do funkcji toovarious hello portalu Azure lub klasycznego portalu Azure i, w zależności od ich roli będzie toocreate może być lub Edytuj użytkowników, Przypisz role administracyjne tooothers, resetowanie haseł użytkowników, zarządzanie licencjami użytkowników i Zarządzanie domenami, między innymi. Użytkownik, któremu przypisano rolę administratora ma hello te same uprawnienia we wszystkich hello usługi chmury, które zostały zasubskrybowane przez organizację, niezależnie od tego, czy przypisać hello roli w portalu usługi Office 365 hello lub w hello klasycznego portalu Azure lub za pomocą hello Moduł Azure AD dla programu Windows PowerShell.
...
* **Administrator zabezpieczeń**: użytkownicy z tą rolą mają wszystkie uprawnienia tylko do odczytu hello rolę czytelnika zabezpieczeń hello plus hello możliwości toomanage konfiguracji związanych z zabezpieczeniami usług: Azure Active Directory Identity Protection, Zarządzanie tożsamościami uprzywilejowanymi i bezpieczeństwo usługi Office 365 i Centrum zgodności. Więcej informacji na temat uprawnień usługi Office 365 są dostępne pod adresem [uprawnień w programie Office 365 zabezpieczeń hello & Centrum zgodności](https://support.office.com/en-us/article/Permissions-in-the-Office-365-Security-Compliance-Center-d10608af-7934-490a-818e-e68f17d0e9c1).
...
| Możliwość | Nie można wykonać |
| --- | --- |
| <p>Wyświetlanie informacji o firmy i użytkownika</p><p>Zarządzanie biletami pomocy technicznej pakietu Office</p><p>Wykonywanie operacji rozliczeń i zakupów dla produktów pakietu Office</p><p>Resetowanie haseł użytkowników</p>
<p>Resetowanie haseł innych administratorów</p> <p>Tworzenie i zarządzanie widokami użytkownika</p><p>Tworzenie, edycję, usuwanie użytkowników i grup i zarządzanie licencjami użytkowników</p><p>Zarządzanie domenami</p><p>Zarządzanie informacjami o firmy</p><p>Delegowanie ról administracyjnych tooothers</p><p>Używanie synchronizacji katalogów</p><p>Włącz lub Wyłącz uwierzytelnianie wieloskładnikowe</p><p>Wyświetlanie dzienników inspekcji</p> |Nie dotyczy |
...
toolearn tooassign ról administracyjnych tooa użytkownika w usłudze Azure Active Directory, zobacz temat [przypisać role tooadministrator w wersji zapoznawczej usługi Azure Active Directory użytkownika](active-directory-users-assign-role-azure-portal.md).
