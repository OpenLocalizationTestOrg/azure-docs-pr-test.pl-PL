...
Aby dowiedzieć się, jak przypisywanie ról administracyjnych do użytkownika w usłudze Azure Active Directory, zobacz [przypisać użytkownika do ról administratora w wersji zapoznawczej usługi Azure Active Directory](active-directory-users-assign-role-azure-portal.md).
