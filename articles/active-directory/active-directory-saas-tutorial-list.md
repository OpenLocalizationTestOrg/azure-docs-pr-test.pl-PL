---
title: "aaaSaaS samouczków integracji aplikacji do użycia z usługą Azure AD | Dokumentacja firmy Microsoft"
description: "Konfigurowanie usługi Azure Active Directory pojedynczego logowania jednokrotnego integracji z szerokiej gamy oprogramowania innych firm jako aplikacje usługi."
...
toohelp zintegrować z włączoną obsługę chmury [(SaaS)](https://azure.microsoft.com/overview/what-is-saas/) aplikacji za pomocą usługi Azure Active Directory, opracowaliśmy kolekcji samouczków, które umożliwia przeprowadzenie konfiguracji.

Gdzie mamy wskazówki inicjowania obsługi administracyjnej użytkowników, firma Microsoft uwzględniła samouczek aplikacji dla użytkownika alokacji w hello prawej kolumnie następny samouczek aplikacji toohello.

Aby hello pełną listę aplikacji SaaS, które zostały wstępnie zintegrowanych z usługą Azure AD, zobacz hello [Active Directory Marketplace](https://azuremarketplace.microsoft.com/marketplace/apps/category/azure-active-directory-apps).

## <a name="saas-tutorials"></a>Samouczki SaaS
...
| ![logo](./media/active-directory-saas-tutorial-list/SaaSApp_360Online.png)| [360 w trybie online](active-directory-saas-360online-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/SaaSApp_AdaptiveSuite.png)| [Pakiet adaptacyjną](active-directory-saas-adaptivesuite-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/SaaSApp_AdobeCreateiveCloud.png)| [Adobe Creative chmury](active-directory-saas-adobe-creative-cloud-tutorial.md)
...
| ![logo](./media/active-directory-saas-tutorial-list/SaaSApp_Alcumus.png)| [Informacje o Alcumus programu Exchange](active-directory-saas-alcumus-info-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/SaaSApp_AmazonWebServices.png)| [Usług Amazon Web Services (AWS)](active-directory-saas-amazon-web-service-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/SaaSApp_AssetBank.png)| [Bank zasobów](active-directory-saas-assetbank-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-atlassian-cloud-tutorial.png)| [Atlassian chmury](active-directory-saas-atlassian-cloud-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/SaaSApp_AtomicLearning.png)| [Niepodzielne Learning](active-directory-saas-atomiclearning-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/SaaSApp_BambooHR.png)| [Bambus HR](active-directory-saas-bamboo-hr-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/saasapp_bambubysproutsocial.png)| [Bambu przez społecznego główką](active-directory-saas-bambubysproutsocial-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-bcinthecloud-tutorial.png)| [BC w hello chmury](active-directory-saas-bcinthecloud-tutorial.md)
...
| ![logo](./media/active-directory-saas-tutorial-list/SaaSApp_BGS_Online.png)| [Ekspresyjne w trybie Online](active-directory-saas-bgsonline-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/SaaSApp_Birst.png)| [Analityka biznesowa Agile Birst](active-directory-saas-birst-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/SaaSApp_BlackboardLearnShibboleth.png)| [Tablica informacji - Shibboleth](active-directory-saas-blackboard-learn-shibboleth-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/SaaSApp_BlackboardLearn.png)| [Tablica Dowiedz się więcej.](active-directory-saas-blackboard-learn-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/SaaSApp_Bridge.png)| [Mostek](active-directory-saas-bridge-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/SaaSApp_Brightspace.png)| [Brightspace przez Desire2Learn](active-directory-saas-brightspace-desire2learn-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/SaaSApp_Bynder.png)| [Bynder](active-directory-saas-bynder-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/SaaSApp_CAPPM.png)| [PPM URZĘDU CERTYFIKACJI](active-directory-saas-cappm-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/SaaSApp_Canvas.png)| [Kanwy LMS](active-directory-saas-canvas-lms-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/SaaSApp_Capriza.png)| [Capriza](active-directory-saas-capriza-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/SaaSApp_Central_Desktop.png)| [Centralna pulpitu](active-directory-saas-central-desktop-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/saasapp_cernercentral.png)| [Cerner środkowo - logowania jednokrotnego](active-directory-saas-cernercentral-tutorial.md)| [Środkowe Cerner — Inicjowanie obsługi użytkowników](active-directory-saas-cernercentral-provisioning-tutorial.md)
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-certify-tutorial.png)| [Certyfikowanie](active-directory-saas-certify-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-cezannehrsoftware-tutorial.png)| [Oprogramowanie Cezanne HR](active-directory-saas-cezannehrsoftware-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/SaaSApp_Cisco_Spark.png)| [Platforma Spark Cisco](active-directory-saas-cisco-spark-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-citrix-gotomeeting-tutorial.png)| [Citrix GoToMeeting](active-directory-saas-citrix-gotomeeting-tutorial.md)| [Citrix GoToMeeting — Inicjowanie obsługi użytkowników](active-directory-saas-citrixgotomeeting-provisioning-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-clever-tutorial.png)| [Inteligentne](active-directory-saas-clever-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-collaborativeinnovation-tutorial.png)| [Wspólne innowacji](active-directory-saas-collaborativeinnovation-tutorial.md)
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-competencyiq-tutorial.png)| [Kompetencja IQ](active-directory-saas-competencyiq-tutorial.md)
...
| ![logo](./media/active-directory-saas-tutorial-list/SaaSApp_CornerstoneOnDemand.png)| [Podstawy na żądanie](active-directory-saas-cornerstone-ondemand-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/SaaSApp_Coupa.png)| [Coupa](active-directory-saas-coupa-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/SaaSApp_CSStars.png)| [CS gwiazdek](active-directory-saas-cs-stars-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/SaaSApp_Deputy.png)| [Zastępcy](active-directory-saas-deputy-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-direct-tutorial.png)| [Bezpośrednie](active-directory-saas-direct-tutorial.md)
| ![logo](./media/active-directory-saas-tutorial-list/SaaSApp_Directions.png)| [Instrukcje w systemie Microsoft](active-directory-saas-directions-microsoft-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-docusign-tutorial.png)| [DocuSign](active-directory-saas-docusign-tutorial.md)|[DocuSign — Inicjowanie obsługi użytkowników](active-directory-saas-docusign-provisioning-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/SaaSApp_Domo.png)| [Domo](active-directory-saas-domo-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/SaaSApp_DowJonesFactiva.png)| [Factiva Nowak knie](active-directory-saas-dowjones-factiva-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-dropboxforbusiness-tutorial.png)| [Dropbox dla firm](active-directory-saas-dropboxforbusiness-tutorial.md)| [Dropbox dla firm — Inicjowanie obsługi użytkowników](active-directory-saas-dropboxforbusiness-provisioning-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/SaaSApp_Envoy.png)| [Wysłannika](active-directory-saas-envoy-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/SaaSApp_FirmPlay.png)| [FirmPlay - propagowanie pracownika dla rekrutacji](active-directory-saas-firmplay-tutorial.md)
...
| ![logo](./media/active-directory-saas-tutorial-list/SaaSApp_FlatterFiles.png)| [Płaska plików](active-directory-saas-flatter-files-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-fuse-tutorial.png)| [Łączenie](active-directory-saas-fuse-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-google-apps-tutorial.png)| [Usługi Google Apps](active-directory-saas-google-apps-tutorial.md)|[Usługi Google Apps — Inicjowanie obsługi użytkowników](active-directory-saas-google-apps-provisioning-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-greenhouse-tutorial.png)| [Cieplarnianych](active-directory-saas-greenhouse-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/SaaSApp_Halogen_Software.png)| [Chlorowców oprogramowania](active-directory-saas-halogen-software-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/SaaSApp_HostedGraphite.png)| [Hostowanej grafitu](active-directory-saas-hostedgraphite-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/SaaSApp_Icertis.png)| [Kontrakt Icertis platformy zarządzania](active-directory-saas-icertisicm-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/SaaSApp_IglooSoftware.png)| [Igloo oprogramowania](active-directory-saas-igloo-software-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/saasapp_ilms.png)| [iLMS](active-directory-saas-ilms-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/SaaSApp_ImageRelay.png)| [Przekazywanie obrazu](active-directory-saas-imagerelay-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-inforretailinformationmanagement-tutorial.png)| [Infor detalicznej — Zarządzanie informacji](active-directory-saas-inforretailinformationmanagement-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-iqnavigatorvms-tutorial.png)| [IQNavigator maszyny Wirtualne](active-directory-saas-iqnavigatorvms-tutorial.md)||
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-kantegassoforbamboo-tutorial.png)| [Usługa rejestracji Jednokrotnej Kantega dla Bambus](active-directory-saas-kantegassoforbamboo-tutorial.md)||
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-kantegassoforbitbucket-tutorial.png)| [Usługa rejestracji Jednokrotnej Kantega dla Bitbucket](active-directory-saas-kantegassoforbitbucket-tutorial.md)||
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-kantegassoforconfluence-tutorial.png)| [Usługa rejestracji Jednokrotnej Kantega dla zlewiska](active-directory-saas-kantegassoforconfluence-tutorial.md)||
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-kantegassoforfisheyecrucible-tutorial.png)| [Usługa rejestracji Jednokrotnej Kantega dla typu rybie oko/tygiel](active-directory-saas-kantegassoforfisheyecrucible-tutorial.md)||
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-keeperpasswordmanager-tutorial.png)| [Opiekun menedżera haseł](active-directory-saas-keeperpasswordmanager-tutorial.md)
...
| ![logo](./media/active-directory-saas-tutorial-list/SaaSApp_LandGorillaClient.png)| [Ziemi Gorilla klienta](active-directory-saas-landgorilla-tutorial.md)
| ![logo](./media/active-directory-saas-tutorial-list/saasapp_lcvista.png)| [LCVista](active-directory-saas-lcvista-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/SaaSApp_LearningAtWork.png)| [Learning w miejscu pracy](active-directory-saas-learning-at-work-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/SaaSApp_LifesizeCloud.png)| [Lifesize chmury](active-directory-saas-lifesize-cloud-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/SaaSApp_LinkedInElevate.png)| [LinkedIn podniesienia uprawnień](active-directory-saas-linkedinelevate-tutorial.md)| [LinkedIn podniesienia uprawnień - użytkownika inicjowania obsługi administracyjnej](active-directory-saas-linkedinelevate-provisioning-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/SaaSApp_LinkedInLearning.png)| [LinkedIn Learning](active-directory-saas-linkedinlearning-tutorial.md)| [Learning LinkedIn — Inicjowanie obsługi użytkowników](active-directory-saas-linkedinlearning-provisioning-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/saasapp_linkedinsalesnavigator.png)| [Nawigator sprzedaży LinkedIn](active-directory-saas-linkedinsalesnavigator-tutorial.md)| [Nawigator sprzedaży LinkedIn — Inicjowanie obsługi użytkowników](active-directory-saas-linkedinsalesnavigator-provisioning-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/SaaSApp_Lynda.com.png)| [Witryny lynda.com](active-directory-saas-lynda-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/saasapp_menlosecurity.png)| [Menlo zabezpieczeń](active-directory-saas-menlosecurity-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/SaaSApp_Mimecast.png)| [Konsola administracyjna Mimecast](active-directory-saas-mimecast-admin-console-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/saasapp_moxiengage.png)| [Moxi komunikować](active-directory-saas-moxiengage-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/SaaSApp_NetSuite.png)| [Netsuite](active-directory-saas-netsuite-tutorial.md)| [Netsuite — Inicjowanie obsługi użytkowników](active-directory-saas-netsuite-provisioning-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/SaaSApp_NewSignature.png)| [Nowy Portal zarządzania platformy Microsoft Azure podpisu chmury](active-directory-saas-newsignature-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-oc-tanner-tutorial.png)| [A. C. napisu Czarnecka - AppreciateHub](active-directory-saas-oc-tanner-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-overdrive-books-tutorial.png)| [Overdrive książek](active-directory-saas-overdrive-books-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-perceptionunitedstates-tutorial.png)| [Z punktu widzenia użytkownika Stanów Zjednoczonych (z systemem innym niż UltiPro)](active-directory-saas-perceptionunitedstates-tutorial.md)||
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-predictixassortmentplanning-tutorial.png)| [Planowanie wybór Predictix](active-directory-saas-predictix-assortment-planning-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-predictixordering-tutorial.png)| [Kolejność Predictix](active-directory-saas-predictixordering-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/SaaSApp_Predictic.png)| [Cena Predictix raportowania](active-directory-saas-predictixpricereporting-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/saasapp_procore.png)| [Procore logowania jednokrotnego](active-directory-saas-procoresso-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/SaaSApp_ProofpointOnDemand.png)| [Proofpoint na żądanie](active-directory-saas-proofpoint-ondemand-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/SaaSApp_Questetra_BPM_Suite.png)| [Pakiet Questetra BPM](active-directory-saas-questetra-bpm-suite-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/SaaSApp_RallySoftware.png)| [Rally oprogramowania](active-directory-saas-rally-software-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-reward-gateway-tutorial.png)| [Brama osób trzecich](active-directory-saas-reward-gateway-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/SaaSApp_Salesforce.png)| [Piaskownica usług SalesForce](active-directory-saas-salesforce-sandbox-tutorial.md)| [Piaskownica SalesForce — Inicjowanie obsługi użytkowników](active-directory-saas-salesforce-sandbox-provisioning-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/SaaSApp_Salesforce.png)| [Salesforce](active-directory-saas-salesforce-tutorial.md)| [SalesForce — Inicjowanie obsługi użytkowników](active-directory-saas-salesforce-provisioning-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/saasapp_confluencegmbh.png)| [Logowania jednokrotnego SAML dla zlewiska przez rozpoznawania GmbH](active-directory-saas-samlssoconfluence-tutorial.md)
| ![logo](./media/active-directory-saas-tutorial-list/saasapp_jiragmbh.png)| [Logowania jednokrotnego SAML dla Jira przez rozpoznawania GmbH](active-directory-saas-samlssojira-tutorial.md)
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-sapboc-tutorial.png)| [Program SAP BusinessObjects chmury](active-directory-saas-sapboc-tutorial.md)
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-sap-customer-cloud-tutorial.png)| [Chmura SAP dla klienta](active-directory-saas-sap-customer-cloud-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/SaaSApp_SapHanaCloudPlatform.png)| [Uwierzytelnianie tożsamości SAP HANA Cloud Platform](active-directory-saas-sap-hana-cloud-platform-identity-authentication-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/SaaSApp_SapHanaCloudPlatform.png)| [Platforma chmury SAP HANA](active-directory-saas-sap-hana-cloud-platform-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-scclifecycle-tutorial.png)| [Cykl życia SCC](active-directory-saas-scc-lifecycle-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/SaaSApp_Sciforma.png)| [Sciforma](active-directory-saas-sciforma-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/SaaSApp_SciQuestSpendDirector.png)| [SciQuest spędzają na katalog](active-directory-saas-sciquest-spend-director-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/saasapp_sensoscientific.png)| [System monitorowania temperatury SensoScientific bezprzewodowej](active-directory-saas-sensoscientific-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/saasapp_servicechannel.png)| [Obiektu ServiceChannel](active-directory-saas-servicechannel-tutorial.md)
| ![logo](./media/active-directory-saas-tutorial-list/SaaSApp_ServiceNow.png)| [Usługi ServiceNow](active-directory-saas-servicenow-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/SaaSApp_SilkRoad.png)| [Pakiet SilkRoad życia](active-directory-saas-silkroad-life-suite-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-soonr-tutorial.png)| [Soonr w miejscu pracy](active-directory-saas-soonr-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/SaaSApp_Splunk.png)| [Splunk Enterprise i Splunk chmury](active-directory-saas-splunkenterpriseandsplunkcloud-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-symantec-tutorial.png)| [Usługi zabezpieczeń firmy Symantec w sieci Web (WSS)](active-directory-saas-symantec-tutorial.md)||
...
| ![logo](./media/active-directory-saas-tutorial-list/SaaSApp_TableauOnline.png)| [TABLEAU w trybie Online](active-directory-saas-tableauonline-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/SaaSApp_Tableau.png)| [TABLEAU serwera](active-directory-saas-tableauserver-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/SaaSApp_Teamwork.png)| [Praca w zespole](active-directory-saas-teamwork-tutorial.md)
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-thefundingportal-tutorial.png)| [Witaj fundusze portalu](active-directory-saas-thefundingportal-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-tigertext-tutorial.png)| [Bezpieczne Messenger TigerText](active-directory-saas-tigertext-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/SaaSApp_TOPdesk.png)| [TOPdesk - bezpieczne](active-directory-saas-topdesk-secure-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/SaaSApp_WizergosProductivitySoftware.png)| [Oprogramowanie Wizergos](active-directory-saas-wizergosproductivitysoftware-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-workday-tutorial.png)| [Dzień roboczy](active-directory-saas-workday-tutorial.md)| [Produktu WORKDAY — Inicjowanie obsługi użytkowników](active-directory-saas-workday-inbound-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/SaaSApp_WorksMobile.png)| [MOBILE DZIAŁANIA](active-directory-saas-worksmobile-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-xmatters-ondemand-tutorial.png)| [xMatters na żądanie](active-directory-saas-xmatters-ondemand-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/SaaSApp_Yardi.png)| [Szkoleń elektronicznych Yardi](active-directory-saas-yardielearning-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-yonyx-tutorial.png)| [Przewodniki interakcyjne Yonyx](active-directory-saas-yonyx-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-zoho-mail-tutorial.png)| [Zoho poczty](active-directory-saas-zoho-mail-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/saasapp_zscalerprivateaccess.png  )| [Dostęp do prywatnego Zscaler (ZPA)](active-directory-saas-zscalerprivateaccess-tutorial.md)|
