...
W tym artykule pomóc toounderstand hello typowych problemów osób krój podczas dodawania aplikacji w galerii Azure AD i co można zrobić tooresolve je.
...
W pewnych okolicznościach, może upłynąć 1 – 2 minuty (i czasami dłużej) dla aplikacji tooappear po dodaniu tooyour katalogu. Chociaż nie jest to normalne obniżenie wydajności hello widać, dodanie aplikacji hello jest w toku, klikając hello **powiadomienia** ikonę (hello dzwonka) w hello górnym rogu hello [Azure Portal](https://portal.azure.com/)i wyszukując **w toku** lub **Ukończono** powiadomień z etykietą **tworzenia aplikacji.**
...
Jeśli potrzebujesz pomocy, informacje o aplikacji hello [listy samouczki dotyczące tooIntegrate aplikacji SaaS w usłudze Azure Active Directory](https://docs.microsoft.com/azure/active-directory/active-directory-saas-tutorial-list) artykuł jest toostart dobrym miejscem.

W toothis dodanie hello [biblioteki dokumentów aplikacji w usłudze Azure AD](https://docs.microsoft.com/azure/active-directory/active-directory-apps-index) ułatwiają toolearn więcej informacji na temat rejestracji jednokrotnej z usługą Azure AD i jej działania.
...
6.  Kliknij hello **kopiowania** **ikona** toohello rogu hello **błąd kopiowania** toocopy pole tekstowe wszystkich hello tooshare szczegóły powiadomienia o inżyniera grupa pomocy technicznej lub produktu
