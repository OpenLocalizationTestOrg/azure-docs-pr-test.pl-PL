...
Z tego samouczka, dowiesz się, jak toointegrate Zscaler Beta w usłudze Azure Active Directory (Azure AD).

Integracja z usługą Azure AD Zscaler Beta zapewnia hello następujące korzyści:

- Można kontrolować w usłudze Azure AD, kto ma dostęp tooZscaler w wersji Beta
- Można włączyć użytkownika użytkownicy tooautomatically get zalogowane tooZscaler (logowanie jednokrotne) w wersji Beta z konta usługi Azure AD
...
tooconfigure integracji usługi Azure AD z wersji Zscaler Beta należy hello następujące elementy:
...
1. Dodawanie Zscaler w wersji Beta z galerii hello
2. Konfigurowanie i testowanie usługi Azure AD logowanie jednokrotne

## <a name="adding-zscaler-beta-from-hello-gallery"></a>Dodawanie Zscaler w wersji Beta z galerii hello
tooconfigure hello integracji Zscaler w wersji Beta do usługi Azure AD, należy tooadd Zscaler Beta z hello galerii tooyour listę zarządzanych aplikacji SaaS.

**tooadd Zscaler Beta z galerii hello wykonaj hello następujące kroki:**
...
4. W polu wyszukiwania hello wpisz **Zscaler Beta**.
...
5. W panelu wyników hello, wybierz **Zscaler Beta**, a następnie kliknij przycisk **Dodaj** przycisk aplikacji hello tooadd.
...
Dla pojedynczego logowania jednokrotnego toowork usługi Azure AD musi tooknow użytkownika odpowiednikiem hello w wersji Zscaler Beta jest tooa użytkownika w usłudze Azure AD. Innymi słowy relację łącza między użytkownika usługi Azure AD i hello użytkownikowi w wersji Zscaler Beta musi toobe ustanowione.

W wersji Zscaler Beta, należy przypisać wartość hello hello **nazwy użytkownika** w usłudze Azure AD jako wartość hello hello **Username** tooestablish hello łącze relacji.

tooconfigure i testowych usługi Azure AD rejestracji jednokrotnej z wersji Zscaler Beta, należy po bloków konstrukcyjnych hello toocomplete:
...
4. **[Tworzenie użytkownika testowego Zscaler Beta](#creating-a-zscaler-beta-test-user)**  -toohave odpowiednikiem Simona Britta w wersji Zscaler Beta, który jest połączony toohello usługi Azure AD reprezentację użytkownika.
...
W tej sekcji można włączyć usługi Azure AD rejestracji jednokrotnej w hello portalu Azure i skonfigurować rejestracji jednokrotnej w wersji Zscaler Beta aplikacji.

**tooconfigure usługi Azure AD rejestracji jednokrotnej z wersji Zscaler Beta, wykonaj hello następujące kroki:**

1. W portalu Azure na powitania hello **Zscaler Beta** strona integracji aplikacji, kliknij przycisk **logowanie jednokrotne**.
...
3. Na powitania **Zscaler Beta domeny i adres URL** sekcji, wykonaj następujące kroki hello:

    ![Konfigurowanie rejestracji jednokrotnej](./media/active-directory-saas-zscaler-beta-tutorial/tutorial_zscalerbeta_url.png)

    W polu tekstowym adres URL hello logowania jednokrotnego wpisz adres URL hello używany przez Twoje użytkowników toosign na tooyour Zscaler Beta aplikacji.

    > [!NOTE] 
    > Masz tooupdate tej wartości z hello rzeczywisty adres URL logowania. Skontaktuj się z [zespół obsługi klienta w wersji Beta Zscaler](https://www.zscaler.com/company/contact) tooget tej wartości. 
...
6. Na powitania **Zscaler Beta konfiguracji** kliknij **skonfigurować Zscaler Beta** tooopen **Konfigurowanie logowania jednokrotnego** okna. Kopiuj hello **SAML pojedynczy znak na adres URL usługi** z hello **sekcji krótkimi opisami.**
...
7. W oknie przeglądarki innej witryny sieci web Zaloguj się za tooyour Zscaler Beta witryny firmy jako administrator.
...
5. W sekcji serwer Proxy hello wykonaj hello następujące kroki:   
    ...
    b. W polu tekstowym adres hello, wpisz **gateway.zscalerbeta.net**.
...
tooenable usługi Azure AD użytkownicy toolog tooZscaler Beta, muszą być elastycznie tooZscaler Beta. W przypadku hello Zscaler Beta Inicjowanie obsługi to zadanie ręczne.
...
1. Zaloguj się za tooyour **Zscaler Beta** dzierżawy.
...
> [!NOTE]
> Możesz użyć innych Zscaler Beta użytkownika konta tworzenia narzędzi lub interfejsów API dostarczonych przez tooprovision Zscaler Beta konta użytkownika usługi Azure AD.

### <a name="assigning-hello-azure-ad-test-user"></a>Przypisanie użytkownika testowego hello Azure AD

W tej sekcji możesz włączyć toouse Simona Britta Azure logowania jednokrotnego za udzielanie dostępu tooZscaler Beta.

![Przypisz użytkownika][200] 

**tooassign tooZscaler Simona Britta Beta, wykonaj hello następujące kroki:**

1. W portalu Azure hello, otwórz widok aplikacji hello, a następnie przejdź do widoku katalogu toohello i przejść za**aplikacje dla przedsiębiorstw** kliknięcie **wszystkie aplikacje**.

    ![Przypisz użytkownika][201] 

2. Z listy aplikacji hello wybierz **Zscaler Beta**.
...
Po kliknięciu hello Zscaler Beta kafelka w hello Panel dostępu, należy pobrać automatycznie zalogowane tooyour Zscaler Beta aplikacji.
