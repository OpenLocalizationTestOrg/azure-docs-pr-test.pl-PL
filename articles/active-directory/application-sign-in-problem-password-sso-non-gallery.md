...
---
# <a name="problems-signing-in-tooan-azure-ad-gallery-application-configured-for-password-single-sign-on"></a>Problemy przy logowaniu tooan galerii Azure AD aplikacji skonfigurowana dla hasła logowania jednokrotnego
