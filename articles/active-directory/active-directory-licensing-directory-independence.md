...
> [!NOTE]
> W przeciwieństwie do innych zasobów platformy Azure dzierżawcy nie są zasobami podrzędnymi subskrypcji platformy Azure. Jeśli anulowania subskrypcji platformy Azure lub ważność, można nadal uzyskać dostępu do danych dzierżawy przy użyciu programu Azure PowerShell, interfejsu API Graph platformy Azure lub Centrum administracyjnego usługi Office 365. Można również skojarzyć inną subskrypcję z dzierżawą.
>
