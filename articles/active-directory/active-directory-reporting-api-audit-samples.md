...
Witaj zakres tego tematu jest tooprovide o przykładowy kod hello **inspekcji interfejsu API**.
...
Uwierzytelniania aplikacji nie będzie działać, jeśli dzierżawy znajduje się w regionie UE hello. Użyj uwierzytelniania użytkowników do uzyskiwania dostępu do hello interfejs API inspekcji jako rozwiązanie alternatywne do czasu firma Microsoft rozwiązać problem hello. 
...
### <a name="executing-hello-powershell-script"></a>Wykonywanie skryptu programu PowerShell hello
...
Witaj skrypt zwraca dane wyjściowe z hello inspekcji raportu w formacie JSON. Tworzy również `audit.json` pliku z hello same dane wyjściowe. Możesz eksperymentować, modyfikując hello skryptu tooreturn danych z innych raportów ujmij w komentarz hello formatów wyjściowych, które nie muszą.
...
* Czy chcesz, aby toocustomize hello przykłady w tym temacie? Zapoznaj się z hello [inspekcji usługi Azure Active Directory dokumentacja interfejsu API](active-directory-reporting-api-audit-reference.md). 
