...
8. Kliknij przycisk **zapisać** górnej części bloku.
...
* **Dostęp do & Identyfikator tokenu okresy istnienia (w minutach)**: okres istnienia tokenu elementu nośnego OAuth 2.0 używane do uzyskiwania dostępu do chronionych zasobów. Usługa Azure AD B2C wystawia tylko tokeny Identyfikatora, w tym momencie. Ta wartość powinna zostać zastosowana do tokenów dostępu, jak również w przypadku dodania ich obsługę.
  * Domyślne = 60 minut.
