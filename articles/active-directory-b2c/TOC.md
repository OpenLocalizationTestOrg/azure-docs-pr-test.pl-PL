...
## [Za pomocą interfejsu API Azure AD Graph hello](active-directory-b2c-devquickstarts-graph-dotnet.md)
## [Uzyskiwanie tokenów dostępu](active-directory-b2c-access-tokens.md)
## [Wyłączanie weryfikacji e-mail](active-directory-b2c-reference-disable-ev.md)
## [Konfigurowanie tokenów](active-directory-b2c-token-session-sso.md)
## [Włączanie usługi MFA](active-directory-b2c-reference-mfa.md)
## [Używanie atrybutów niestandardowych](active-directory-b2c-reference-custom-attr.md)
## [Dostosowywanie hello interfejsu użytkownika](active-directory-b2c-reference-ui-customization.md)
...
## [Użyj hello raportowania interfejsu API](active-directory-b2c-reference-usage-reporting-api.md)
...
### Konfigurowanie dostawców OIDC/OAUTH2
