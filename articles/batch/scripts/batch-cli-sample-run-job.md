...
[!code-azurecli[główne](../../../cli_scripts/batch/run-job/run-job.sh "uruchamiania zadania")]
...
| [Utwórz zadanie wsadowe az](https://docs.microsoft.com/cli/azure/batch/task#create) | Dodaje zadanie do określonego zadania wsadowego.  |
| [Pokaż zadania wsadowego az](https://docs.microsoft.com/cli/azure/batch/task#show) | Pobiera szczegóły zadania z określonego zadania wsadowego.  |
| [Lista zadań wsadowych az](https://docs.microsoft.com/cli/azure/batch/task#list) | Zawiera listę zadań skojarzonych z określonego zadania.  |
