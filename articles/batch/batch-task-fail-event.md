...
---
# <a name="task-fail-event"></a>Zdarzenie niepowodzenie zadania

 To zdarzenie jest emitowany, gdy zadanie zostanie ukończone z błędem. Obecnie wszystkie kody zakończenia niezerową są traktowane jako błędy. To zdarzenie zostanie wyemitowany *oprócz* zadania zakończenie zdarzenia i może być używane toodetect, gdy zadanie nie powiodło się.


 Witaj poniższy przykład przedstawia treści hello zadania niepowodzenie zdarzeń.
