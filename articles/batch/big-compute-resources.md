...
Jest to przewodnik toohelp zasobów tootechnical Uruchom Twojej równolegle na dużą skalę, partii i wysokiej wydajności (HPC) obciążeń na platformie Azure. Rozszerzenie pliku wsadowym istniejących lub HPC toohello obciążeń chmury Azure lub tworzenia nowych rozwiązań Big obliczeniowe przy użyciu usług zakresu Azure.

## <a name="solutions-options"></a>Opcje rozwiązania
Więcej informacji na temat opcji obliczeniowe duży na platformie Azure, a następnie wybierz pozycję hello podejście dla potrzeb obciążenia i biznesowych.

* [Rozwiązania partii i HPC](batch-hpc-solutions.md)
* [Wideo: Big obliczeniowych w chmurze hello Azure i HPC](https://azure.microsoft.com/documentation/videos/teched-europe-2014-big-compute-in-the-cloud-with-high-performance-computing-on-azure/)

## <a name="azure-batch"></a>Azure Batch
[Wsadowe](https://azure.microsoft.com/services/batch/) jest usługą platformy, która umożliwia łatwe Włącz toocloud systemu Linux i Windows aplikacji i uruchom zadania bez konfigurowania i zarządzania harmonogramu klastra i zadania. Za pomocą aplikacji klienckich toointegrate SDK hello partii zadań Azure za pomocą różnych języków, etap tooAzure danych i Utwórz potoki wykonywania zadania.
...
Wdróż lub rozszerzyć Twoje istniejące systemu Windows lub Linux HPC klastra tooAzure toorun obciążeń intensywnie wykorzystujących obliczeń.  
...
Użyj tych toodeploy szablonów platformy Azure, które klastrów HPC systemu Linux.
...
[Microsoft MPI](https://msdn.microsoft.com/library/bb524831.aspx) (MS-MPI) to implementacja firmy Microsoft hello interfejsu przekazywanie komunikatów standardowych umożliwiające tworzenie i uruchamianie aplikacji równoległych na platformie Windows hello.
...
* [Skonfiguruj aplikacje MPI toorun Linux RDMA klastra](../virtual-machines/linux/classic/rdma-cluster.md?toc=%2fazure%2fvirtual-machines%2flinux%2fclassic%2ftoc.json)
* [Konfigurowanie klastra RDMA systemu Windows z pakietem Microsoft HPC toorun MPI aplikacji](../virtual-machines/windows/classic/hpcpack-rdma-cluster.md?toc=%2fazure%2fvirtual-machines%2fwindows%2fclassic%2ftoc.json)
...
* [Partii stoczni](https://azure.github.io/batch-shipyard/) zestawu narzędzi w celu łatwiejszego wdrażania partii stylu Dockerized obciążeń tooAzure partii
...
* Zobacz też [nowości w partii](https://azure.microsoft.com/updates/?service=batch) lub subskrypcja toohello [kanału informacyjnego RSS](https://azure.microsoft.com/updates/feed/?service=batch).
