...
* Przewodnik dotyczący zmiany portalu starego do nowego portalu, zobacz: [odwołanie do nawigowania w klasycznym portalu Azure](http://go.microsoft.com/fwlink/?LinkId=529715)
