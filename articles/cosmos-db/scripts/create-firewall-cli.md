...
---
# <a name="azure-cosmos-db-create-a-firewall-using-the-azure-cli"></a>Azure DB rozwiązania Cosmos: Utworzenie zapory przy użyciu wiersza polecenia platformy Azure

Ten przykładowy skrypt CLI tworzy zasady zapory dla każdego typu konta bazy danych Azure rozwiązania Cosmos. 
...
[!code-azurecli-interactive[główne](../../../cli_scripts/cosmosdb/secure-cosmosdb-create-firewall/secure-cosmosdb-create-firewall.sh?highlight=38-42 "utworzyć zapory bazy danych Azure rozwiązania Cosmos")]
...
| [Utwórz az cosmosdb](https://docs.microsoft.com/cli/azure/cosmosdb#create) | Tworzy konto Azure CosmosDB. |
| [AZ cosmosdb aktualizacji](https://docs.microsoft.com/cli/azure/cosmosdb#update) | Aktualizuje konto Azure CosmosDB do uwzględnienia ustawień zapory. |
