...
---
# <a name="azure-cosmos-db-create-a-firewall-using-hello-azure-cli"></a>Azure DB rozwiązania Cosmos: Utworzenie zapory przy użyciu hello wiersza polecenia platformy Azure
...
| [AZ cosmosdb aktualizacji](https://docs.microsoft.com/cli/azure/cosmosdb#update) | Aktualizuje ustawienia zapory tooinclude Azure CosmosDB konta. |
