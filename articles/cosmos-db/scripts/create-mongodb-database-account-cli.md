...
---
# <a name="azure-cosmos-db-create-an-mongodb-api-account-using-hello-azure-cli"></a>Azure rozwiązania Cosmos bazy danych: Tworzenie konta bazy danych MongoDB interfejsu API przy użyciu hello wiersza polecenia platformy Azure
