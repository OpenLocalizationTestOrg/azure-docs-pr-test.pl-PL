...
[!code-azurecli-interactive[główne](../../../cli_scripts/cosmosdb/scale-cosmosdb-replicate-multiple-regions/scale-cosmosdb-replicate-multiple-regions.sh?highlight=21-31 "skalowania bazy danych rozwiązania Cosmos Azure w wielu regionach")]
