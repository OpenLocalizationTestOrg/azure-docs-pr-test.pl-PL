...
---
# <a name="scale-azure-cosmos-db-container-throughput-using-the-azure-cli"></a>Przepływność kontenera Azure DB rozwiązania Cosmos skali przy użyciu wiersza polecenia platformy Azure

W tym przykładzie skaluje przepływność kontener dla dowolnego rodzaju kontenera Azure DB rozwiązania Cosmos.  
...
[!code-azurecli-interactive[główne](../../../cli_scripts/cosmosdb/scale-cosmosdb-throughput/scale-cosmosdb-throughput.sh?highlight=40-46 "przepływności bazy danych rozwiązania Cosmos Azure skali")]
