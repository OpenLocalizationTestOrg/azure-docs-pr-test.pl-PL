...
---
# <a name="scale-azure-cosmos-db-container-throughput-using-hello-azure-cli"></a>Przepływność kontenera Azure DB rozwiązania Cosmos skali przy użyciu hello wiersza polecenia platformy Azure
