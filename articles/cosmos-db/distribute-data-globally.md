...
Azure DB rozwiązania Cosmos umożliwia podjęcie bazy danych konta w trybie offline w określonym regionie i przełączyć go do trybu online później. Regiony oznaczone w trybie offline aktywnie nie uczestniczą w replikacji i nie są częścią sekwencji trybu failover. Dzięki temu można zablokować ostatniej znanej dobrej bazy danych obrazu w regionów odczytu zanim zetknie potencjalnie ryzykowne uaktualnień do aplikacji.
