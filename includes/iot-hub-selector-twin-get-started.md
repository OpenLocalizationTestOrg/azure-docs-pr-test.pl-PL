...
> [!NOTE]
> W tej chwili twins urządzenia są dostępne tylko z urządzeń łączących się za pomocą protokołu MQTT Centrum IoT. Zapoznaj się z [Obsługa MQTT] [ lnk-devguide-mqtt] artykułu instrukcje na temat do konwersji istniejącej aplikacji urządzenia do używania MQTT.
