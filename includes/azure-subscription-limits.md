...
| Reguły alertów dla subskrypcji |250 |250 |

<sup>1</sup>dodatkowe mała liczba wystąpienia jako jednego rdzenia się limitu core hello pomimo przy użyciu częściowego core.
