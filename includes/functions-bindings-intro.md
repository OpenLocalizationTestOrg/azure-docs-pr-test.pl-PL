...
* [C#](../articles/azure-functions/functions-reference-csharp.md), [F #](../articles/azure-functions/functions-reference-fsharp.md), lub [węzła](../articles/azure-functions/functions-reference-node.md) dokumentacja dla deweloperów
* [Azure funkcje wyzwalaczy i powiązań pojęcia](..\articles\azure-functions\functions-triggers-bindings.md)
