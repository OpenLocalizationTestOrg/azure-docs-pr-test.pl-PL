...
| Sieć |Sieć wirtualna zarówno bramę usługi ExpressRoute, jak i bramy sieci VPN  | Usuwanie bramy sieci VPN, przed rozpoczęciem migracji, a następnie utwórz ponownie bramy sieci VPN, po zakończeniu migracji. Dowiedz się więcej o [migracji ExpressRoute](../articles/expressroute/expressroute-migration-classic-resource-manager.md).|
| Sieć |Usługi ExpressRoute z łączami autoryzacji  | Usuń obwodu ExpressRoute, aby virtaul połączenie sieciowe przed rozpoczęciem migracji, a następnie utwórz ponownie połączenie po zakończeniu migracji. Dowiedz się więcej o [migracji ExpressRoute](../articles/expressroute/expressroute-migration-classic-resource-manager.md). |
...
| Wystąpienia obliczeniowe |Centrum zabezpieczeń Azure rozszerzeń o sieć Wirtualną, która ma bramy sieci VPN w łączności przesyłania lub bramę usługi ExpressRoute z lokalnego serwera DNS |Centrum zabezpieczeń Azure automatycznie instaluje rozszerzenia na maszynach wirtualnych, aby monitorować ich zabezpieczeń i zgłaszanie alertów. Rozszerzenia te zwykle uzyskać zainstalowana automatycznie, jeśli Centrum zabezpieczeń Azure jest włączona dla tej subskrypcji. Migracja bramy ExpressRoute nie jest obecnie obsługiwany, a bramy sieci VPN z połączeniem przesyłania utracenia dostępu lokalnego. Usuwanie ExpressRoute bramy lub Migrowanie bramy sieci VPN z połączeniem przesyłania powoduje, że dostęp do Internetu dla konta magazynu maszyny Wirtualnej, aby zostać utracone po kontynuowanie zatwierdzania migracji. W takim przypadku zgodnie z obiektu blob ze stanem agenta gościa nie można wypełnić, nie będzie kontynuowana migracji. Zalecane jest wyłączenie 3 godziny przed kontynuowaniem migracji zasad Centrum zabezpieczeń Azure w subskrypcji. |
