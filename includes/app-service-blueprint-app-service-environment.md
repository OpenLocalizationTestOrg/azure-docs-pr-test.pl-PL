* [Konfigurowanie rozproszonego geograficznie zasięgu aplikacji](../articles/app-service-web/app-service-app-service-environment-geo-distributed-scale.md)
* [Implementowanie warstwowej architektury zabezpieczeń](../articles/app-service-web/app-service-app-service-environment-layered-security.md) 
* [Konfigurowanie zapory aplikacji internetowej za pomocą środowiska usługi App Service](../articles/app-service-web/app-service-app-service-environment-web-application-firewall.md)
